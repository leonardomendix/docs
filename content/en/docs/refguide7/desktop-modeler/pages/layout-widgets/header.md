...
{{< figure src="/attachments/refguide7/desktop-modeler/pages/layout-widgets/header/header-layout.png" alt="" >}}
A basic lay-out utilizing a header to give the page structure.

{{< figure src="/attachments/refguide7/desktop-modeler/pages/layout-widgets/header/header-page.png" alt="" >}}
