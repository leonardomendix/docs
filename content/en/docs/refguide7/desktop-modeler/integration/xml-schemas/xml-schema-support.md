...
If the XSD contains any of the unsupported constructs then they will be highlighted in the mapping editor with this warning icon: {{< figure src="/attachments/refguide7/desktop-modeler/integration/xml-schemas/xml-schema-support/16843903.png" alt="" >}}
...
Hex binary type is recognized as a string so operations on binary types are not applicable for hex binary (for example, MTOM attachment)
