...
The **Logs** tab shows the stored logs in the database.
 ...
 {{< figure src="/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-log-tool/Overview.png" alt="" >}}

You can start and stop the log tool via the "play" button in the header.

Double-clicking a log message shows its details.

 {{< figure src="/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-log-tool/View_Message.png" alt="" >}}
...
{{< figure src="/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-log-tool/Options.png" alt="" >}}
...
{{< figure src="/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-log-tool/Protections.png" alt="" >}}
...
{{< figure src="/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-log-tool/Levels.png" alt="" >}}
