...
{{< figure src="/attachments/addons/apd-addon/rg-apd/rg-one-apm/Performance_Tool_Tree_View.png" alt="" >}}
...
{{< figure src="/attachments/addons/apd-addon/rg-apd/rg-one-apm/Performance_Tool_Browse_Microflow.png" alt="" >}}

This is the SQL statements during an action:

{{< figure src="/attachments/addons/apd-addon/rg-apd/rg-one-apm/Performance_Tool_Browse_Actions.png" alt="" >}}
...
{{< figure src="/attachments/addons/apd-addon/rg-apd/rg-one-apm/Measurements_Tool.png" alt="" >}}
