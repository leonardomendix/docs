...
The trap tool shows the traps that are stored.
 ...
 {{< figure src="/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-trap-tool/Overview.png" alt="" >}}
...
When you select a trap, you get to see all the messages in that trap.
 ...
 {{< figure src="/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-trap-tool/Individual_Trap.png" alt="" >}}
...
{{< figure src="/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-trap-tool/Output_Queue.png" alt="" >}}
...
{{< figure src="/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-trap-tool/Options.png" alt="" >}}
...
{{< figure src="/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-trap-tool/Options_Protections.png" alt="" >}}
...
{{< figure src="/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-trap-tool/Options_Exclusions.png" alt="" >}}
...
{{< figure src="/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-trap-tool/Edit_Exclusion.png" alt="" >}}
...
{{< figure src="/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-trap-tool/Options_Triggers.png" alt="" >}}
