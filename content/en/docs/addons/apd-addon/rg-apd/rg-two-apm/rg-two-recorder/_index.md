...
{{< figure src="/attachments/addons/apd-addon/rg-apd/rg-two-apm/rg-two-recorder/select-browsers.png" alt="" >}}

When recording a browser, the user has to confirm the following message:

{{< figure src="/attachments/addons/apd-addon/rg-apd/rg-two-apm/rg-two-recorder/Browser_agent_recording_notice.png" alt="" >}}
...
{{< figure src="/attachments/addons/apd-addon/rg-apd/rg-two-apm/rg-two-recorder/recorder.png" alt="" >}}
