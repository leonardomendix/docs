...
{{< figure src="/attachments/addons/apd-addon/rg-apd/rg-two-apm/rg-two-settings/settings.png" alt="" >}}
...
{{< figure src="/attachments/addons/apd-addon/rg-apd/rg-two-apm/rg-two-settings/api_key_dialog.png" alt="" >}}
