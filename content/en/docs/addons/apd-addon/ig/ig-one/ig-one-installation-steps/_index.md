...
{{< figure src="/attachments/addons/apd-addon/ig/ig-one/ig-one-installation-steps/Commit.png" alt="" >}}
...
{{< figure src="/attachments/addons/apd-addon/ig/ig-one/ig-one-installation-steps/Import_Module_Package.png" alt="" >}}
...
{{< figure src="/attachments/addons/apd-addon/ig/ig-one/ig-one-installation-steps/Language_Operations_Header.png" alt="" >}}

{{< figure src="/attachments/addons/apd-addon/ig/ig-one/ig-one-installation-steps/Language_Operations_APM.png" alt="" >}}

{{< figure src="/attachments/addons/apd-addon/ig/ig-one/ig-one-installation-steps/Language_Operations_Footer.png" alt="" >}}

## 5 Add Permissions

Add `APMAgent.Admin` permissions to the project **Security** > **User roles** tab for a selected administrator role.

{{< figure src="/attachments/addons/apd-addon/ig/ig-one/ig-one-installation-steps/Add_Permissions.png" alt="" >}}
...
{{< figure src="/attachments/addons/apd-addon/ig/ig-one/ig-one-installation-steps/Add_To_Navigation.png" alt="" >}}
...
{{< figure src="/attachments/addons/apd-addon/ig/ig-one/ig-one-installation-steps/Project_Settings_After_Startup.png" alt="" >}}
...
{{< figure src="/attachments/addons/apd-addon/ig/ig-one/ig-one-installation-steps/Welcome_Dialog.png" alt="" >}}
