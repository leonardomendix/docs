...
{{< figure src="/attachments/addons/apd-addon/ig/ig-one/ig-one-uninstall-steps/Delete_Module.png" alt="" >}}
...
{{< figure src="/attachments/addons/apd-addon/ig/ig-one/ig-one-uninstall-steps/Commit.png" alt="" >}}
...
{{< figure src="/attachments/addons/apd-addon/ig/ig-one/ig-one-uninstall-steps/Delete_Permissions.png" alt="" >}}
...
{{< figure src="/attachments/addons/apd-addon/ig/ig-one/ig-one-uninstall-steps/Delete_From_Navigation.png" alt="" >}}
...
{{< figure src="/attachments/addons/apd-addon/ig/ig-one/ig-one-uninstall-steps/Revert_After_Startup.png" alt="" >}}
