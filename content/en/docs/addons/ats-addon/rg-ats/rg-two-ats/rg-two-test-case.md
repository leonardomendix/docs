...
{{< figure src="/attachments/addons/ats-addon/rg-ats/rg-two-ats/rg-two-test-case/testcase-details.png" alt="" >}}
...
{{< figure src="/attachments/addons/ats-addon/rg-ats/rg-two-ats/rg-two-test-case/search-button.png" alt="" >}}
...
{{< figure src="/attachments/addons/ats-addon/rg-ats/rg-two-ats/rg-two-test-case/select-function-action.png" alt="" >}}.
...
| Icon                                     | Meaning  |
| ---------------------------------------- | -------- |
| {{< figure src="/attachments/addons/ats-addon/rg-ats/rg-two-ats/rg-two-test-case/setting-gears-2.png" alt="" >}} | Setup    |
| {{< figure src="/attachments/addons/ats-addon/rg-ats/rg-two-ats/rg-two-test-case/hammer-2.png" alt="" >}}       | Teardown |
