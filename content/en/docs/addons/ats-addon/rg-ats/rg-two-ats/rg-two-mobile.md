...
4.  Select the **Devices** tab:
    ...
    {{< figure src="/attachments/addons/ats-addon/rg-ats/rg-two-ats/rg-two-mobile/chrome-settings-1.png" alt="" >}}
...
7.  Select **Add**.
    ...
    {{< figure src="/attachments/addons/ats-addon/rg-ats/rg-two-ats/rg-two-mobile/chrome-settings-2.png" alt="" >}}
...
{{< figure src="/attachments/addons/ats-addon/rg-ats/rg-two-ats/rg-two-mobile/run-configuration.png" alt="" >}}
...
6. In the mobile device toolbar, select the new device profile **ATS Mobile**.
    ...
    {{< figure src="/attachments/addons/ats-addon/rg-ats/rg-two-ats/rg-two-mobile/chrome-settings-3.png" alt="" >}}
