...
{{< figure src="/attachments/addons/ats-addon/rg-ats/rg-one-ats/rg-one-projects/21168198.png" alt="The project selector dropdown" >}}

## 5 Project Dashboard

The **Project Dashboard** is the first page you see when you open a project.

{{< figure src="/attachments/addons/ats-addon/rg-ats/rg-one-ats/rg-one-projects/dashboard.png" alt="The project dashboard" >}}
