...
5.  Enter a name in the dialog and click **OK**. This opens the **Constant** dialog. where you can add the following properties:
	...
	* Default value: True
	...
	{{< figure src="/attachments/addons/ats-addon/ht/ht-two/ht-two-increase-recorder-helper-coverage/add-constant.png" alt="" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/ht-two/ht-two-increase-recorder-helper-coverage/changed-mx-name.png" alt="" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/ht-two/ht-two-increase-recorder-helper-coverage/not-recordable-image.png" alt="" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/ht-two/ht-two-increase-recorder-helper-coverage/2-mx-names.png" alt="" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/ht-two/ht-two-increase-recorder-helper-coverage/no-mx-name-listview.png" alt="" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/ht-two/ht-two-increase-recorder-helper-coverage/no-mx-name-listview-app-e.png" alt="" >}}

You can manually enter a class in the **Class** of Mendix Studio Pro with an mx-name to solve this:

{{< figure src="/attachments/addons/ats-addon/ht/ht-two/ht-two-increase-recorder-helper-coverage/mx-name-listview.png" alt="" >}}

{{< figure src="/attachments/addons/ats-addon/ht/ht-two/ht-two-increase-recorder-helper-coverage/mx-name-listview-app-e.png" alt="" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/ht-two/ht-two-increase-recorder-helper-coverage/extra-class-name.png" alt="" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/ht-two/ht-two-increase-recorder-helper-coverage/mx-name-in-name.png" alt="" >}}
