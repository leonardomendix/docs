...
{{< figure src="/attachments/addons/ats-addon/ht/ht-one/ht-one-getting-started/my-projects.png" alt="" >}}

To create a new project, follow these steps:

1. Click **Add project/Create new project**, which opens the *Create new project/library* page:

      {{< figure src="/attachments/addons/ats-addon/ht/ht-one/ht-one-getting-started/create-new-project.png" alt="" >}}
...
3.  Click **Save & Open** at the bottom of the page to open the **Project Dashboard**.
      ...
      {{< figure src="/attachments/addons/ats-addon/ht/ht-one/ht-one-getting-started/project-dashboard-empty.png" alt="" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/ht-one/ht-one-getting-started/configuration-getting-started.png" alt="" >}}
...
1. Click **New** in the top bar, which opens the **Selenium hub** dialog box:
      ...
      {{< figure src="/attachments/addons/ats-addon/ht/ht-one/ht-one-getting-started/selenium-hub-dialog.png" alt="" >}}
...
1. Click **New** in the top bar, which opens the **Application** dialog box.
      ...
      {{< figure src="/attachments/addons/ats-addon/ht/ht-one/ht-one-getting-started/application-dialog.png" alt="" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/ht-one/ht-one-getting-started/repository-empty.png" alt="" >}}
...
3. Enter a clear description for your test case. In case others may need to know what your test case does, use a template to make sure all aspects of the case are described clearly.
      ...
      {{< figure src="/attachments/addons/ats-addon/ht/ht-one/ht-one-getting-started/create-new-test-case.png" alt="" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/ht-one/ht-one-getting-started/test-case-page.png" alt="" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/ht-one/ht-one-getting-started/ats-information-dialog.png" alt="" >}}
...
2. You can now open the Mendix application you want to test in another tab of the browser and start testing the application manually. The test steps you take will now be recorded and saved in the chosen test case.
      ...
      {{< figure src="/attachments/addons/ats-addon/ht/ht-one/ht-one-getting-started/recording-session-cp.png" alt="" >}}
...
3.  Click **Save** to save your actions for this event.
      ...
      **Action mapping** | This shows all the available actions for this event. Click  **Select** if you want to choose a different action.
      ...
      {{< figure src="/attachments/addons/ats-addon/ht/ht-one/ht-one-getting-started/recorded-test-steps.png" alt="" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/ht-one/ht-one-getting-started/data-set-test-case.png" alt="" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/ht-one/ht-one-getting-started/show-usages-test-case.png" alt="" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/ht-one/ht-one-getting-started/stories-test-case.png" alt="" >}}
...
3. Enter a clear description for your test suite. Others may need to know what your test suite does. It might be handy to use a template to make sure all aspects of the suite are present.
      ...
      {{< figure src="/attachments/addons/ats-addon/ht/ht-one/ht-one-getting-started/create-new-test-suite.png" alt="" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/ht-one/ht-one-getting-started/test-suite-page.png" alt="" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/ht-one/ht-one-getting-started/select-test.png" alt="" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/ht-one/ht-one-getting-started/show-usages-test-suite.png" alt="" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/ht-one/ht-one-getting-started/stories-test-suite.png" alt="" >}}

## 6 Run Configuration

When you click **Run** in the upper-right corner of your test case, the **Select Run Configuration** page will open.

{{< figure src="/attachments/addons/ats-addon/ht/ht-one/ht-one-getting-started/run-configuration.png" alt="" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/ht-one/ht-one-getting-started/monitoring-results-pending.png" alt="" >}}
