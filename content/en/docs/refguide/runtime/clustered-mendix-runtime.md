...
{{< figure src="/attachments/refguide/runtime/clustered-mendix-runtime/16844074.png" alt="" >}}
...
{{< figure src="/attachments/refguide/runtime/clustered-mendix-runtime/16844072.png" alt="" >}}
...
{{< figure src="/attachments/refguide/runtime/clustered-mendix-runtime/2018-03-01_17-49-15.png" alt="" >}}
...
{{< figure src="/attachments/refguide/runtime/clustered-mendix-runtime/2018-03-01_17-42-38.png" alt="" >}}

The `Value` values can easily be obtained by performing a find on the `Key` values of a list of `Data` instances.

{{< figure src="/attachments/refguide/runtime/clustered-mendix-runtime/2018-03-01_17-56-37.png" alt="" >}}
