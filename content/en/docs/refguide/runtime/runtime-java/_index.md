...
{{< figure src="/attachments/refguide/runtime/runtime-java/2.jpg" alt="" >}}

Or as shown in the Mendix Cloud:

{{< figure src="/attachments/refguide/runtime/runtime-java/4.jpg" alt="" >}}
...
{{< figure src="/attachments/refguide/runtime/runtime-java/5.jpg" alt="" >}}
...
{{< figure src="/attachments/refguide/runtime/runtime-java/6.jpg" alt="" >}}
