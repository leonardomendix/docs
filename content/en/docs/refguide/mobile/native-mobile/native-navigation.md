...
{{% image_container width="250" %}}{{< figure src="/attachments/refguide/mobile/native-mobile/native-navigation/singlestack.gif" >}}{{% /image_container %}}
...
{{% image_container width="250" %}}{{< figure src="/attachments/refguide/mobile/native-mobile/native-navigation/multiplestacks.gif" >}}{{% /image_container %}}
...
{{% image_container width="250" %}}{{< figure src="/attachments/refguide/mobile/native-mobile/native-navigation/popups.gif" >}}{{% /image_container %}}
