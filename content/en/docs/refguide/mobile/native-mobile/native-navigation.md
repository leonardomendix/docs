...
{{% image_container width="250" %}}{{< figure src="/attachments/refguide/mobile/native-mobile/native-navigation/header.png" alt="An example of the default header on iOS." >}}{{% /image_container %}}
...
{{% image_container width="250" %}}{{< figure src="/attachments/refguide/mobile/native-mobile/native-navigation/bottombar.png" alt="An example of the default bottom bar on iOS." >}}{{% /image_container %}}
...
{{% image_container width="250" %}}{{< figure src="/attachments/refguide/mobile/native-mobile/native-navigation/singlestack.gif" alt="" >}}{{% /image_container %}}
...
{{% image_container width="250" %}}{{< figure src="/attachments/refguide/mobile/native-mobile/native-navigation/multiplestacks.gif" alt="" >}}{{% /image_container %}}
...
{{% image_container width="250" %}}{{< figure src="/attachments/refguide/mobile/native-mobile/native-navigation/popups.gif" alt="" >}}{{% /image_container %}}
