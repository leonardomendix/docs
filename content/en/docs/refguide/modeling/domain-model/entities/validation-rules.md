...
{{< figure src="/attachments/refguide/modeling/domain-model/entities/validation-rules/customer-validation-rules.png" alt="" >}}
...
{{< figure src="/attachments/refguide/modeling/domain-model/entities/validation-rules/validation-rule-properties.png" alt="" >}}
...
{{< figure src="/attachments/refguide/modeling/domain-model/entities/validation-rules/startup-error.png" alt="" >}}
...
{{< figure src="/attachments/refguide/modeling/domain-model/entities/validation-rules/unique-validation-rule-unresolved.png" alt="" >}}
...
{{< figure src="/attachments/refguide/modeling/domain-model/entities/validation-rules/unique-validation-rule-resolved.png" alt="" >}}
...
{{< figure src="/attachments/refguide/modeling/domain-model/entities/validation-rules/one-to-many-assoc.PNG" alt="" >}}
...
{{< figure src="/attachments/refguide/modeling/domain-model/entities/validation-rules/one-to-one-assoc.PNG" alt="" >}}
...
{{< figure src="/attachments/refguide/modeling/domain-model/entities/validation-rules/startup-error-assoc.png" alt="" >}}
