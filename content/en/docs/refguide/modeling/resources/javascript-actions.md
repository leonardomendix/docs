...
{{% image_container width="400" %}}{{< figure src="/attachments/refguide/modeling/resources/javascript-actions/javascript-action-settings-no-para.png" alt="javascript settings" >}}{{% /image_container %}}
...
{{% image_container width="400" %}}{{< figure src="/attachments/refguide/modeling/resources/javascript-actions/call-js-action-dialog.png" alt="call javascript action dialog" >}}{{% /image_container %}}
...
{{% image_container width="450" %}}{{< figure src="/attachments/refguide/modeling/resources/javascript-actions/type-parameter.png" alt="type parameter" >}}{{% /image_container %}}
...
{{% image_container width="450" %}}{{< figure src="/attachments/refguide/modeling/resources/javascript-actions/expose-jsaction.png" alt="expose action" >}}{{% /image_container %}}
...
{{% image_container width="450" %}}{{< figure src="/attachments/refguide/modeling/resources/javascript-actions/documentation-pro.png" alt="documentation" >}}{{% /image_container %}}
...
{{% image_container width="450" %}}{{< figure src="/attachments/refguide/modeling/resources/javascript-actions/documentation-js-file.png" alt="documentation js file" >}}{{% /image_container %}}
