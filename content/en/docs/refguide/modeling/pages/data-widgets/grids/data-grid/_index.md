...
![](/attachments/refguide/modeling/pages/data-widgets/grids/data-grid/data-grid.png)
...
{{% image_container width="250" %}}![](/attachments/refguide/modeling/pages/data-widgets/grids/data-grid/data-grid-properties.png)
{{% /image_container %}}
