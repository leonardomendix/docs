...
{{< figure src="/attachments/refguide/modeling/pages/data-widgets/list-view/list-view-example-profile.png" alt="" >}} 
...
{{% image_container width="250" %}}{{< figure src="/attachments/refguide/modeling/pages/data-widgets/list-view/list-view-properties.png" alt="" >}}
{{% /image_container %}}
