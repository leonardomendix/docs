...
{{% image_container width="250" %}}![xpath variable constraint](/attachments/refguide/modeling/pages/data-widgets/data-sources/xpath-source/xpath-variable-constraint.png){{% /image_container %}}
