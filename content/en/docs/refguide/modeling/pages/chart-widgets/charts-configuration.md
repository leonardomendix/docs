...
![Generic Chart properties dialog](/attachments/refguide/modeling/pages/chart-widgets/charts-configuration/line-chart-chart-properties.png)
...
* The *Pie Charts* and *Heat Maps* support only a single series containing a single set of data
  ...
  ![Pie chart dialog showing tabs for Data source and Data points](/attachments/refguide/modeling/pages/chart-widgets/charts-configuration/widget-data-source.png)
...
1. Data source<a name="data-source"></a>
    ...
    ![Edit series Data source tab](/attachments/refguide/modeling/pages/chart-widgets/charts-configuration/series-item-data-source.png)
...
2. Data points<a name="data-points"></a>
    ...
    ![Edit series Data points tab](/attachments/refguide/modeling/pages/chart-widgets/charts-configuration/series-item-data-points.png)
...
3. Appearance
    ...
    ![Edit series Appearance tab](/attachments/refguide/modeling/pages/chart-widgets/charts-configuration/series-item-appearance.png)
...
4. Static Series
    ...
    ![Data series Static series tab](/attachments/refguide/modeling/pages/chart-widgets/charts-configuration/series-item-static.png)

5. Dynamic Series

    Configuration of the series if it is a dynamic series.

    ![Data series Dynamic series tab](/attachments/refguide/modeling/pages/chart-widgets/charts-configuration/series-item-dynamic.png)
...
7. Advanced <a name="advanced"></a>
    ...
    ![Edit series Advanced tab](/attachments/refguide/modeling/pages/chart-widgets/charts-configuration/series-item-advanced.png)
...
![Generic Chart Appearance tab](/attachments/refguide/modeling/pages/chart-widgets/charts-configuration/widget-appearance.png)
...
![Generic Chart REST tab](/attachments/refguide/modeling/pages/chart-widgets/charts-configuration/widget-rest.png)
...
![Generic Chart Advanced Tab](/attachments/refguide/modeling/pages/chart-widgets/charts-configuration/widget-advanced.png)
