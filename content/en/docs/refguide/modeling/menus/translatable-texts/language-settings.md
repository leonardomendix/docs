...
{{< figure src="/attachments/refguide/modeling/menus/translatable-texts/language-settings/01_project_settings.png" alt="" >}}
...
{{< figure src="/attachments/refguide/modeling/menus/translatable-texts/language-settings/add-language.png" alt="" >}}
