...
![Find Options](/attachments/refguide/modeling/menus/edit-menu/find-and-find-advanced/find-options.jpg)
...
3. In the **Look in** section unselect items in your app where you do not want to search in:  
   ...
   ![Look in Section](/attachments/refguide/modeling/menus/edit-menu/find-and-find-advanced/look-in.jpg)

You can see search results in the **Find Results** pane:

![Search Results](/attachments/refguide/modeling/menus/edit-menu/find-and-find-advanced/search-results.jpg)
...
1.  Click **Edit** > **Find** **Advanced** in the top-bar or press <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>F</kbd>.
    ...
    ![](/attachments/refguide/modeling/menus/edit-menu/find-and-find-advanced/find-advanced-dialog-box.png)
3.  In the **Search for** option, select **Microflow actions**:
    ![](/attachments/refguide/modeling/menus/edit-menu/find-and-find-advanced/search-for-microflow-actions.png)
...
2. In the **Find Advanced** dialog box, select **Unused items** in the **Search for** option:
   ...
   ![](/attachments/refguide/modeling/menus/edit-menu/find-and-find-advanced/search-for-unused-items.png)
...
2. Select an element (for example, an entity) and click **Edit** > **Find usages** in the top-bar or right-click an element and select **Find usages**:
    {{% image_container width="350" %}}![Find Usages](/attachments/refguide/modeling/menus/edit-menu/find-and-find-advanced/find-usages.png){{% /image_container %}}

Studio Pro shows all usages of this entity in the **Find Results** pane. 
![Find Results Pane](/attachments/refguide/modeling/menus/edit-menu/find-and-find-advanced/found-usages.png)
