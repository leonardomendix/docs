...
* Mendix Studio Pro China Edition
    ...
    * You will be able to download Mendix Studio Pro, as part of your initial sign up:
       {{< figure src="/attachments/developerportal/deploy/tencent-deploy/download-studio-pro.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/cluster-manager-navigation.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/purchase-resources.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/cluster-overview.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/cluster-activity-logs.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/cluster-details.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/cluster-managers.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/cluster-manager-invite.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/namespace-activity-logs.png" alt="" >}}

#### 3.3.1 Apps

The **Apps** tab of namespace details lists all the apps which are deployed to this namespace.

{{< figure src="/attachments/developerportal/deploy/tencent-deploy/namespace-apps.png" alt="" >}}
...
2. Click **Invite Member**.
    ...
    {{< figure src="/attachments/developerportal/deploy/tencent-deploy/namespace-members.png" alt="" >}}
...
5. Click **Invite** to send an invite to this person.
    ...
    {{< figure src="/attachments/developerportal/deploy/tencent-deploy/namespace-member-invite.png" alt="" >}}
...
1. On the **Members** tab of the namespace details, click **Remove** next to the member you want to remove.
    ...
    {{< figure src="/attachments/developerportal/deploy/tencent-deploy/namespace-member-remove.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/image31.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/image32.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/environments-none.png" alt="" >}}
...
6. Click **Next**.
    ...
    {{< figure src="/attachments/developerportal/deploy/tencent-deploy/create-environment.png" alt="" >}}
...
9. Select a **Storage plan** from the list of plans in the dropdown. This will have the format `file-plan-…` where the suffix reflects the environment.
    ...
    {{< figure src="/attachments/developerportal/deploy/tencent-deploy/image7.png" alt="" >}}
...
11. You will see your new environment listed. An *in-progress* icon will be shows next to the resource plans until they have been provisioned.
    ...
    {{< figure src="/attachments/developerportal/deploy/tencent-deploy/environments-new.png" alt="" >}}
...
1. On the **Environments** page for your app in the Developer Portal, click **Create Package**.
    ...
    {{< figure src="/attachments/developerportal/deploy/tencent-deploy/image9.png" alt="" >}}

2. Select the branch which contains the commit for which you want to create a deployment package and click **Next**.
   
    {{< figure src="/attachments/developerportal/deploy/tencent-deploy/image10.png" alt="" >}}

3. Select the revision/commit for which you want to create a deployment package and click **Next**.
   
    {{< figure src="/attachments/developerportal/deploy/tencent-deploy/image11.png" alt="" >}}
...
6. Click **Build this revision.**
    ...
    {{< figure src="/attachments/developerportal/deploy/tencent-deploy/image12.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/image13.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/image14.png" alt="" >}}
...
4. Click **Transport**.
    ...
    {{< figure src="/attachments/developerportal/deploy/tencent-deploy/image15.png" alt="" >}}
...
7. Click **Continue** to continue to the Start Application confirmation page.
    ...
    {{< figure src="/attachments/developerportal/deploy/tencent-deploy/image16.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/image17.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/image18.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/image19.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/image20.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/image21.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/image22.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/image23.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/delete-environment.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/image24.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/network-tab.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/runtime-tab.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/log-levels-tab.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/tencent-deploy/tls-configuration.png" alt="" >}}
...
* Enable TLS – is TLS enabled for this environment?
    ...
    {{< figure src="/attachments/developerportal/deploy/tencent-deploy/enable-tls.png" alt="" >}}

* Use existing TLS secret or add new tls private key and certificate?

    {{< figure src="/attachments/developerportal/deploy/tencent-deploy/choose-secret.png" alt="" >}}
...
* TLS Private Key File and TLS Certificate File – if you choose to add a new key you will need to upload these two files
    ...
    {{< figure src="/attachments/developerportal/deploy/tencent-deploy/new-tls-key.png" alt="" >}}
