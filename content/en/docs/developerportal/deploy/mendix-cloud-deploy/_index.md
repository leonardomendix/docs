...
{{< figure src="/attachments/developerportal/deploy/mendix-cloud-deploy/appresumed.png" alt="" >}}
...
3. Click **App** in the top menu bar and select **Deploy to Licensed Cloud Node**:
    ...
    {{< figure src="/attachments/developerportal/deploy/mendix-cloud-deploy/deploy-to-cloud-node.png" alt="" >}}

4. Click **Deploy**:

    {{< figure src="/attachments/developerportal/deploy/mendix-cloud-deploy/select-revision.png" alt="" >}}

5. The deployment is now in progress. To see the uploaded package, click **Show online**:

    {{< figure src="/attachments/developerportal/deploy/mendix-cloud-deploy/deployment-started.png" alt="" >}}
...
6. Click **Transport**.
    ...
    {{< figure src="/attachments/developerportal/deploy/mendix-cloud-deploy/transport-to-flex.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/mendix-cloud-deploy/runapp2.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/mendix-cloud-deploy/runapp.png" alt="" >}}
