...
{{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/mx4pc-containerized-architecture.png" alt="" >}}
...
1. Open the **General Settings** page for your app in the Developer Portal.
      ...
      {{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/image2.png" alt="" >}}

2. Click **Cloud Settings**.

3. Click **Mendix for Private Cloud**.
   
    {{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/image3.png" alt="" >}}

4. Click **Set up Mendix for Private Cloud**.
   
    {{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/image4.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/image5.png" alt="" >}}
...
6. Click **Next**.
    ...
    {{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/create-environment.png" alt="" >}}
...
9. Select a **Storage plan** from the list of plans set up in the namespace.
    ...
    {{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/image7.png" alt="" >}}
...
11. You will see your new environment listed. An *in-progress* icon will be shows next to the resource plans until they have been provisioned.
    ...
    {{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/image8.png" alt="" >}}
...
1. On the **Environments** page for your app in the Developer Portal, click **Create Package**.
    ...
    {{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/image9.png" alt="" >}}

2. Select the branch which contains the commit for which you want to create a deployment package and click **Next**.
   
    {{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/image10.png" alt="" >}}

3. Select the revision/commit for which you want to create a deployment package and click **Next**.
   
    {{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/image11.png" alt="" >}}
...
6. Click **Build this revision.**
    ...
    {{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/image12.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/image13.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/image14.png" alt="" >}}
...
4. Click **Transport**.
    ...
    {{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/image15.png" alt="" >}}
...
7. Click **Continue** to continue to the Start Application confirmation page.
    ...
    {{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/image16.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/image17.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/image18.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/image19.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/image20.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/image21.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/image22.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/image23.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/delete-environment.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/image24.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/network-tab.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/runtime-tab.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/log-levels-tab-1.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/log-levels-tab-2.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/log-levels-tab-3.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/tls-configuration.png" alt="" >}}
...
* Enable TLS – is TLS enabled for this environment?
    ...
    {{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/enable-tls.png" alt="" >}}

* Use existing TLS secret or add new tls private key and certificate?

    {{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/choose-secret.png" alt="" >}}
...
* TLS Private Key File and TLS Certificate File – if you choose to add a new key you will need to upload these two files
    ...
    {{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/new-tls-key.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/deprovision-failed.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/private-cloud/private-cloud-deploy/mx4pc-operator-deploy.png" alt="" >}}
