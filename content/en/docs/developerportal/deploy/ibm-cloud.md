...
{{< figure src="/attachments/developerportal/deploy/ibm-cloud/cloud-settings-landing-page.png" >}}
...
4. Select any additional services you need for your app. For more information see [Binding Services](#binding-services), below.
    ...
    {{% image_container width="75%" %}}{{< figure src="/attachments/developerportal/deploy/ibm-cloud/transport-services.png" >}}{{% /image_container %}}
...
{{< figure src="/attachments/developerportal/deploy/ibm-cloud/service-tab.png" >}}
{{% /image_container %}}
...
{{% image_container width="50%" %}}
{{< figure src="/attachments/developerportal/deploy/ibm-cloud/error-desktop-modeler.png" >}}
{{% /image_container %}}
