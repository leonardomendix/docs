...
1. Select your app and click **Configuration**.
   ...
   {{< figure src="/attachments/developerportal/deploy/on-premises-design/deploy-mendix-on-microsoft-windows/deploy-mendix-ha-on-windows-in-microsoft-azure/slave_click_configuration.png" alt="" >}}

2. In the Configuration screen, click **Advanced...**.

   {{< figure src="/attachments/developerportal/deploy/on-premises-design/deploy-mendix-on-microsoft-windows/deploy-mendix-ha-on-windows-in-microsoft-azure/slave_click_advanced.png" alt="" >}}
...
3. In the Advanced screen add a line to Custom Mendix Settings with **Name** _com.mendix.core.isClusterSlave_ and **Value** _true_.
   ...
   {{< figure src="/attachments/developerportal/deploy/on-premises-design/deploy-mendix-on-microsoft-windows/deploy-mendix-ha-on-windows-in-microsoft-azure/slave_add_setting.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/on-premises-design/deploy-mendix-on-microsoft-windows/deploy-mendix-ha-on-windows-in-microsoft-azure/azure_storage_keys.png" alt="" >}}
...
* **Name**: _com.mendix.storage.azure.Container_, **Value**: `<the Azure Storage blob container>`
   ...
   {{< figure src="/attachments/developerportal/deploy/on-premises-design/deploy-mendix-on-microsoft-windows/deploy-mendix-ha-on-windows-in-microsoft-azure/application_storage_settings.png" alt="" >}}
