...
{{< figure src="/attachments/developerportal/deploy/on-premises-design/18580719.jpg" alt="" >}}

### <a name="Option2"></a>2.2 Hosting with a Separate Database Server (Option 2)

{{< figure src="/attachments/developerportal/deploy/on-premises-design/18580718.jpg" alt="" >}}
...
{{< figure src="/attachments/developerportal/deploy/on-premises-design/18580717.jpg" alt="" >}}

### 2.4 Separate Mendix Web Server in a DMZ (Option 4)

{{< figure src="/attachments/developerportal/deploy/on-premises-design/18580720.jpg" alt="" >}}
