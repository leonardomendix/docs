...
2.  Select an issue from the drop-down menu:
	...
	{{< figure src="/attachments/developerportal/support/submit-support-request/issue.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/support/submit-support-request/recommendations.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/support/submit-support-request/activities.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/support/submit-support-request/follow.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/support/submit-support-request/request.png" alt="" >}}
