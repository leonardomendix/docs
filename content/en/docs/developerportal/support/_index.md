...
{{< figure src="/attachments/developerportal/support/legend.png" >}}
{{% /image_container %}}
...
{{< figure src="/attachments/developerportal/support/mendix-cloud.png" >}}
{{% /image_container %}}
...
{{% image_container width="75%" %}}
{{< figure src="/attachments/developerportal/support/private-cloud.png" >}}
{{% /image_container %}}
...
{{< figure src="/attachments/developerportal/support/sap-cloud-platform.png" >}}
{{% /image_container %}}
...
{{% image_container width="40%" %}}
{{< figure src="/attachments/developerportal/support/tencent.png" >}}
{{% /image_container %}}
...
{{% image_container width="75%" %}}
{{< figure src="/attachments/developerportal/support/on-premises.png" >}}
{{% /image_container %}}
