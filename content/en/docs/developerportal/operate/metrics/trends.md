...
{{< figure src="/attachments/developerportal/operate/metrics/trends/nodepermission.jpg" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends/environment.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends/no-ext-reqs.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends/object-cache.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends/user-accounts-logins.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends/jvm-heap.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends/jvm-process-memory.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends/node-os-memory.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends/threadpool-external-reqs.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends/jvm-thread-count.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends/app-cpu.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends/app-disk-usage-bytes.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends/app-disk-usage-pct.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends/app-load.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends/no-db-queries.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends/db-table-vs-index.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends/db-mutations.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends/no-db-connections.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends/db-os-memory.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends/db-cpu-usage.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends/db-disk-usage-bytes.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends/db-disk-usage-pct.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends/db-load.png" alt="" >}}
