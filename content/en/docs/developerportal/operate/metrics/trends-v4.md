...
5. Check **Access to Monitoring** next to the name of the person to whom you want to grant this permission.
    ...
    {{< figure src="/attachments/developerportal/operate/metrics/trends-v4/nodepermission.jpg" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends-v4/environment.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends-v4/no-ext-reqs.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends-v4/user-accounts-logins.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends-v4/jvm-heap.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends-v4/jvm-process-memory.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends-v4/node-os-memory.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends-v4/threadpool-external-reqs.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends-v4/jvm-thread-count.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends-v4/app-cpu.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends-v4/app-disk-usage-pct.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends-v4/no-db-queries.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends-v4/db-table-vs-index.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends-v4/db-mutations.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends-v4/no-db-connections.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends-v4/db-os-memory.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends-v4/db-cpu-usage.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends-v4/db-disk-throughput.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends-v4/db-disk-usage-bytes.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends-v4/db-disk-ios.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends-v4/db-disk-latency.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/operate/metrics/trends-v4/db-burst-balance.png" alt="" >}}
