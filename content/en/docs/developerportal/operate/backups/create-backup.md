...
5. Select the environment for which you want to create a backup snapshot.
    ...
    {{< figure src="/attachments/developerportal/operate/backups/create-backup/environment.png" alt="" >}}

6. Click **Create Backup**.

    {{< figure src="/attachments/developerportal/operate/backups/create-backup/backupoptions.jpg" alt="" >}}
