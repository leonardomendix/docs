...
{{< figure src="/attachments/developerportal/collaborate/stories/stories.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/collaborate/stories/new-sprint.jpg" alt="" >}}
{{% /image_container %}}
...
{{% image_container width="400" %}}
{{< figure src="/attachments/developerportal/collaborate/stories/new-story.png" alt="" >}}
{{% /image_container %}}
...
{{< figure src="/attachments/developerportal/collaborate/stories/new-story-from-sprint.jpg" alt="" >}}
{{% /image_container %}}
...
{{% image_container width="400" %}}
{{< figure src="/attachments/developerportal/collaborate/stories/new-label.png" alt="" >}}
{{% /image_container %}}
...
{{< figure src="/attachments/developerportal/collaborate/stories/import-export.png" alt="" >}}
{{% /image_container %}}
...
{{% image_container width="550" %}}
{{< figure src="/attachments/developerportal/collaborate/stories/labels.png" alt="" >}}
{{% /image_container %}}
...
{{% image_container width="550" %}}
{{< figure src="/attachments/developerportal/collaborate/stories/completed-sprints.png" alt="" >}}
{{% /image_container %}}
...
{{% image_container width="550" %}}
{{< figure src="/attachments/developerportal/collaborate/stories/history.jpg" alt="" >}}
{{% /image_container %}}
...
{{% image_container width="350" %}}
{{< figure src="/attachments/developerportal/collaborate/stories/sprint-options.jpg" alt="" >}}
{{% /image_container %}}
...
{{< figure src="/attachments/developerportal/collaborate/stories/story-context-menu.jpg" alt="" >}}
...
{{< figure src="/attachments/developerportal/collaborate/stories/story-details.png" alt="" >}}
{{% /image_container %}}
...
* Select the story, click **Move**, and then select the new Sprint from the **Move Stories** dialog box
	...
	{{% image_container width="500" %}}{{< figure src="/attachments/developerportal/collaborate/stories/move-story-move-button.jpg" alt="" >}}
	{{% /image_container %}}

* Select the story and drag it to the desired Sprint location:

	{{< figure src="/attachments/developerportal/collaborate/stories/move-story-drag-new.jpg" alt="" >}}

* Click the story title to open the story details page, then click **Move Story**:

	{{< figure src="/attachments/developerportal/collaborate/stories/move-story-details.png" alt="" >}}
...
2. Open **View** > **Stories**. You can see your active Sprints in the **Stories** pane.
	...
	{{< figure src="/attachments/developerportal/collaborate/stories/stories-pane.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/collaborate/stories/stories-to-do.png" alt="" >}}

When you return to your app in the Developer Portal, you will see the new story status:

{{< figure src="/attachments/developerportal/collaborate/stories/status-update.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/collaborate/stories/sprint-status.jpg" alt="" >}}
