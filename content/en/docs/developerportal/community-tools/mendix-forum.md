...
{{< figure src="/attachments/developerportal/community-tools/mendix-forum/questions_example.jpg" alt="" >}}
...
{{< figure src="/attachments/developerportal/community-tools/mendix-forum/questions_profile_card.jpg" alt="" >}}
{{% /image_container %}}
...
{{% image_container width="200" %}}
{{< figure src="/attachments/developerportal/community-tools/mendix-forum/questions_sort_by.jpg" alt="" >}}
{{% /image_container %}}
...
{{< figure src="/attachments/developerportal/community-tools/mendix-forum/questions_specific_page.jpg" alt="" >}}
{{% /image_container %}}
...
{{< figure src="/attachments/developerportal/community-tools/mendix-forum/questions_answer.jpg" alt="" >}}
...
{{< figure src="/attachments/developerportal/community-tools/mendix-forum/questions_answer_editor.jpg" alt="" >}}
...
{{< figure src="/attachments/developerportal/community-tools/mendix-forum/questions_image_button.png" alt="" >}}
...
2.  On the **Ask your question** page, fill in the following details in the editor:
	...
	{{% image_container width="500" %}}{{< figure src="/attachments/developerportal/community-tools/mendix-forum/questions_ask_screen.jpg" alt="" >}}
	{{% /image_container %}}
...
{{< figure src="/attachments/developerportal/community-tools/mendix-forum/ideas_example.jpg" alt="" >}}
...
{{% image_container width="200" %}}
{{< figure src="/attachments/developerportal/community-tools/mendix-forum/ideas_sort_by.jpg" alt="" >}}
{{% /image_container %}}
...
{{< figure src="/attachments/developerportal/community-tools/mendix-forum/ideas_specific_page.jpg" alt="" >}}
...
2.  On the **Submit your idea** page, fill in the following details in the editor:
	...
	{{% image_container width="500" %}}{{< figure src="/attachments/developerportal/community-tools/mendix-forum/ideas_submit_screen.jpg" alt="" >}}
	{{% /image_container %}}
