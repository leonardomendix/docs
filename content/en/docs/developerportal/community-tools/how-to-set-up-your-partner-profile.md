...
3.  If you are authorized as a Partner Profile Editor, click **Edit Partner Profile** to edit the profile:
    ...
    {{< figure src="/attachments/developerportal/community-tools/how-to-set-up-your-partner-profile/edit-partner-profile.png" alt="" >}}
...
4.  Once you are in edit mode, click the form field to edit the Partner Profile:
    ...
    {{< figure src="/attachments/developerportal/community-tools/how-to-set-up-your-partner-profile/edit-profile-field.png" alt="" >}}
...
5.  After you have finished editing, you can make the profile public so that the Mendix community and customers can view it. To do this, simply click **Save and Exit**:
    ...
    {{< figure src="/attachments/developerportal/community-tools/how-to-set-up-your-partner-profile/close-edit.png" alt="" >}}
...
{{< figure src="/attachments/developerportal/community-tools/how-to-set-up-your-partner-profile/header.png" alt="" >}}
{{% /image_container %}}
...
{{< figure src="/attachments/developerportal/community-tools/how-to-set-up-your-partner-profile/address.png" alt="" >}}
{{% /image_container %}}
...
1.  Add a **Summary Title** and a company **Summary**:
	...
	{{% image_container width="550" %}}{{< figure src="/attachments/developerportal/community-tools/how-to-set-up-your-partner-profile/summary.png" alt="" >}}
	{{% /image_container %}}

2.  Add a company **Video** (YouTube or Vimeo) or **Project**:

	{{% image_container width="550" %}}{{< figure src="/attachments/developerportal/community-tools/how-to-set-up-your-partner-profile/video.png" alt="" >}}
	{{% /image_container %}}
...
3.  Add your company's focus **Industries**. These will be used in the filter options on the **Meet our partners** page so that Mendix customers can search for partners in a specific industry.
	...
	{{% image_container width="250" %}}{{< figure src="/attachments/developerportal/community-tools/how-to-set-up-your-partner-profile/industries.png" alt="" >}}
	{{% /image_container %}}

4.  Select the **Types of Service** your company provides:

	{{% image_container width="550" %}}{{< figure src="/attachments/developerportal/community-tools/how-to-set-up-your-partner-profile/service.png" alt="" >}}
	{{% /image_container %}}

5.  Under **Skills**, add the types of skills your company team members can perform:

	{{% image_container width="550" %}}{{< figure src="/attachments/developerportal/community-tools/how-to-set-up-your-partner-profile/skills.png" alt="" >}}
	{{% /image_container %}}
...
6.  In **Geographical Focus**, add the countries where your company is active and/or has coverage. This will be used in the filter option on the **Meet our partners** page so that Mendix customers can search for partners in a specific country.
	...
	{{% image_container width="550" %}}{{< figure src="/attachments/developerportal/community-tools/how-to-set-up-your-partner-profile/geo-focus.png" alt="" >}}
	{{% /image_container %}}
...
{{< figure src="/attachments/developerportal/community-tools/how-to-set-up-your-partner-profile/add-project.png" alt="" >}}
{{% /image_container %}}

This will open the project editor. There are tips in the editor for what you should enter in each field:

{{% image_container width="500" %}}
{{< figure src="/attachments/developerportal/community-tools/how-to-set-up-your-partner-profile/project-editor.png" alt="" >}}
{{% /image_container %}}
...
{{< figure src="/attachments/developerportal/community-tools/how-to-set-up-your-partner-profile/project-buttons.png" alt="" >}}
{{% /image_container %}}
...
{{% image_container width="600" %}}
{{< figure src="/attachments/developerportal/community-tools/how-to-set-up-your-partner-profile/published.png" alt="" >}}
{{% /image_container %}}
...
{{< figure src="/attachments/developerportal/community-tools/how-to-set-up-your-partner-profile/unpublished.png" alt="" >}}
{{% /image_container %}}
...
*  **Add Comment** — opens a dialog box where you can add a comment on the project draft; comments can be viewed in the **Unpublished** projects section
	...
	{{% image_container width="550" %}}{{< figure src="/attachments/developerportal/community-tools/how-to-set-up-your-partner-profile/project-comment.png" alt="" >}}
	{{% /image_container %}}
...
1.  Go to the **Developers** tab, where all the certified Mendix developers in your company are shown:
	...
	{{% image_container width="550" %}}{{< figure src="/attachments/developerportal/community-tools/how-to-set-up-your-partner-profile/team-members.png" alt="" >}}
	{{% /image_container %}}
...
{{< figure src="/attachments/developerportal/community-tools/how-to-set-up-your-partner-profile/testimonials.png" alt="" >}}
{{% /image_container %}}
