...
{{< figure src="/attachments/appstore/widgets/list-view-controls/check-box-filter.gif" alt="" >}}
{{% /image_container %}}
...
{{% image_container width="300" %}}
{{< figure src="/attachments/appstore/widgets/list-view-controls/drop-down-filter.gif" alt="" >}}
{{% /image_container %}}
...
{{% image_container width="300" %}}
{{< figure src="/attachments/appstore/widgets/list-view-controls/drop-down-sort.gif" alt="" >}}
{{% /image_container %}}
...
{{% image_container width="300" %}}
{{< figure src="/attachments/appstore/widgets/list-view-controls/header-sort.gif" alt="" >}}
{{% /image_container %}}
...
* Lower pagination:
	...
	{{% image_container width="300" %}}
	{{< figure src="/attachments/appstore/widgets/list-view-controls/lower-pagination.gif" alt="" >}}
	{{% /image_container %}}
  
* Multiple paginations:

	{{% image_container width="300" %}}
	{{< figure src="/attachments/appstore/widgets/list-view-controls/multiple-pagination.gif" alt="" >}}
	{{% /image_container %}}

* Page size:
	
	{{% image_container width="300" %}}
	{{< figure src="/attachments/appstore/widgets/list-view-controls/page-size.gif" alt="" >}}
	{{% /image_container %}}
...
{{% image_container width="300" %}}
{{< figure src="/attachments/appstore/widgets/list-view-controls/text-box-search.gif" alt="" >}}
{{% /image_container %}}
