...
Clicking the **Edit** icon opens the app page in . If you have permissions to edit the app, you can start editing and collaborating right away.
...
If you are trying to upgrade your Mendix Feedback widget from version 7 to version 8,  will not recognize the current configuration of this widget. Add the Mendix Feedback widget into your page again and configure it accordingly. Then delete the old one.
