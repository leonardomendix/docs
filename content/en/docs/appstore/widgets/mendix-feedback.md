...
{{< figure src="/attachments/appstore/widgets/mendix-feedback/widget.png" alt="" >}}
...
{{< figure src="/attachments/appstore/widgets/mendix-feedback/feedback-mode.png" alt="" >}}

Once you are in feedback mode, you can click anywhere on the screen to leave a comment:

{{< figure src="/attachments/appstore/widgets/mendix-feedback/add-comment.png" alt="" >}}
...
{{< figure src="/attachments/appstore/widgets/mendix-feedback/exit.png" alt="" >}}
...
{{< figure src="/attachments/appstore/widgets/mendix-feedback/view-app.png" alt="" >}}
...
{{% image_container width="450" %}}{{< figure src="/attachments/appstore/widgets/mendix-feedback/share.png" alt="" >}}
{{% /image_container %}}
...
{{% image_container width="450" %}}{{< figure src="/attachments/appstore/widgets/mendix-feedback/app-switcher.png" alt="" >}}
{{% /image_container %}}
...
2.  When the widget is included in your app, ensure that it is added to the homepage of the application. Open the homepage from your app's **App** > **Navigation**:
	...
	{{< figure src="/attachments/appstore/widgets/mendix-feedback/show-page.png" alt="" >}}
...
3.  If the widget has not been added automatically, add it to the desired page or layout by selecting **Add widget** > **Add-on widgets** > **Feedback & Collaboration Widget** and dropping it into a position in the page:
	...
	{{< figure src="/attachments/appstore/widgets/mendix-feedback/feedback-collaboration-widget.png" alt="" >}}
...
{{< figure src="/attachments/appstore/widgets/mendix-feedback/authentication.jpg" alt="" >}}
...
{{< figure src="/attachments/appstore/widgets/mendix-feedback/cannot-recognize-the-old-version.png" alt="" >}}
...
{{< figure src="/attachments/appstore/widgets/mendix-feedback/remove-feedbackwidget-mpk.png" alt="" >}}
