...
This app service can only be used with Studio Pro 8 versions starting with .
...
1. Create an entity called *PageObject*, add a decimal attribute called *LoadingProgress* with a default value of `= 0` (as the  widget expects a decimal value).
...
2. Add a  to display the model list via a button click or another event of your choice.
