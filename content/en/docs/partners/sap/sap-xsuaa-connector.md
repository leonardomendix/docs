...
{{< figure src="/attachments/partners/sap/sap-xsuaa-connector/xsuaa-diagram.png" alt="" >}}
...
{{< figure src="/attachments/partners/sap/sap-xsuaa-connector/trusted-idp.png" alt="" >}}
...
2. Set up the configuration in the sections shown on the screen.
    ...
    {{% image_container width="50%" %}}{{< figure src="/attachments/partners/sap/sap-xsuaa-connector/configurator.png" alt="" >}}{{% /image_container %}}
