...
{{< figure src="/attachments/partners/sap/use-sap-odata-model-creator/model-creator-wizard-1.png" alt="" >}}
...
1. Click **API Business Hub**.
    ...
    {{< figure src="/attachments/partners/sap/use-sap-odata-model-creator/model-creator-wizard-2-api.png" alt="" >}}
...
3. Click **Continue** to see the APIs within the package.
    ...
    {{< figure src="/attachments/partners/sap/use-sap-odata-model-creator/model-creator-wizard-3-api.png" alt="" >}}
...
5. Click **Continue** to see the schemas within the API.
    ...
    {{< figure src="/attachments/partners/sap/use-sap-odata-model-creator/model-creator-wizard-4-api.png" alt="" >}}
...
7. Click **Continue** to proceed to the confirmation screen.
    ...
    {{< figure src="/attachments/partners/sap/use-sap-odata-model-creator/model-creator-wizard-5-api.png" alt="" >}}

8. Click **Generate .mpk** to generate the data model module.

    {{< figure src="/attachments/partners/sap/use-sap-odata-model-creator/model-creator-generated-api.png" alt="" >}}
...
1. Click **SAP Catalog Service**.
    ...
    {{< figure src="/attachments/partners/sap/use-sap-odata-model-creator/model-creator-wizard-2-1-catalog.png" alt="" >}}
...
2. Click **Continue**. 
    ...
    {{< figure src="/attachments/partners/sap/use-sap-odata-model-creator/model-creator-wizard-2-catalog.png" alt="" >}}
...
4. Click **Continue** to see the schemas within the API.
    ...
    {{< figure src="/attachments/partners/sap/use-sap-odata-model-creator/model-creator-wizard-3-catalog.png" alt="" >}}
...
6. Click **Continue** to proceed to the confirmation screen.
    ...
    {{< figure src="/attachments/partners/sap/use-sap-odata-model-creator/model-creator-wizard-4-catalog.png" alt="" >}}

7. Click **Generate .mpk** to generate the data model module.

    {{< figure src="/attachments/partners/sap/use-sap-odata-model-creator/model-creator-generated-catalog.png" alt="" >}}
...
1.  Download the XML metadata file to your local drive.
    ...
    {{< figure src="/attachments/partners/sap/use-sap-odata-model-creator/download-xml.png" alt="" >}}
...
3. Click **Manual**.
    ...
    {{< figure src="/attachments/partners/sap/use-sap-odata-model-creator/upload_metadata.png" alt="" >}}
...
6. Click **Continue** to see the schemas within the metadata.
    ...
    {{< figure src="/attachments/partners/sap/use-sap-odata-model-creator/upload-metadata-schemas.png" alt="" >}}
...
8. Click **Continue** to proceed to the confirmation screen.
    ...
    {{< figure src="/attachments/partners/sap/use-sap-odata-model-creator/upload-metadata-confirmation.png" alt="" >}}
...
10. Once the generation is complete, the **Download File** button appears. Notice that the file name of your data model module is extracted from the metadata file itself.
    ...
    {{< figure src="/attachments/partners/sap/use-sap-odata-model-creator/download_metadata.png" alt="" >}}
...
1. Click **URL** on the first page of the OData Model Creator for SAP solutions.
    ...
    {{< figure src="/attachments/partners/sap/use-sap-odata-model-creator/metadata-url.png" alt="" >}}
...
5. Click **Continue** to proceed to the confirmation screen.
    ...
    {{< figure src="/attachments/partners/sap/use-sap-odata-model-creator/metadata-url-confirmation.png" alt="" >}}
...
7.  Once the generation is complete, the **Download File** button appears. Notice that the file name of your data model module is extracted from the metadata file itself.
    ...
    {{< figure src="/attachments/partners/sap/use-sap-odata-model-creator/download-metadata-url.png" alt="" >}}
...
2. Right-click your project in the **App Explorer** and select **Import module package...**.
    ...
    {{< figure src="/attachments/partners/sap/use-sap-odata-model-creator/import_module_package.png" alt="" >}}
...
3. Use the navigation dialog to find your module, which will have the suffix **.mpk**.
    ...
    {{< figure src="/attachments/partners/sap/use-sap-odata-model-creator/project_explorer.png" alt="" >}}
