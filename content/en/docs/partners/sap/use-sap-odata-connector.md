...
5. Click **Continue**.
    ...
    {{< figure src="/attachments/partners/sap/use-sap-odata-connector/login-catalog.png" alt="" >}}
...
9. Click **Generate .mpk**.
    ...
    {{< figure src="/attachments/partners/sap/use-sap-odata-connector/generate-mpk.png" alt="" >}}
...
14. Right-click the project in the **App Explorer** and select **Import module package…**.
    ...
    {{< figure src="/attachments/partners/sap/use-sap-odata-connector/import-module.png" alt="" >}}
...
15. Find the file that you stored in the /resources folder and import it.
    ...
    {{< figure src="/attachments/partners/sap/use-sap-odata-connector/data-model.png" alt="" >}}
...
{{< figure src="/attachments/partners/sap/use-sap-odata-connector/get-list.png" alt="" >}}
...
4. Select the **Name**, **Category**, and **Price** attributes to display in the data grid.
    ...
    {{< figure src="/attachments/partners/sap/use-sap-odata-connector/show-get-list-result.png" alt="" >}}
