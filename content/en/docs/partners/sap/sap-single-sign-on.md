...
{{< figure src="/attachments/partners/sap/sap-single-sign-on/sign-in.png" alt="" >}}
...
{{< figure src="/attachments/partners/sap/sap-single-sign-on/select-sap-region.png" alt="" >}}

Select the region and you will be asked for your **SAP credentials**.

{{< figure src="/attachments/partners/sap/sap-single-sign-on/sap-login-screen.png" alt="" >}}
...
{{< figure src="/attachments/partners/sap/sap-single-sign-on/app-select-sap-region.png" alt="" >}}
...
{{< figure src="/attachments/partners/sap/sap-single-sign-on/go-back.png" alt="" >}}
...
{{< figure src="/attachments/partners/sap/sap-single-sign-on/server-error.png" alt="" >}}
...
{{< figure src="/attachments/partners/sap/sap-single-sign-on/where-to.png" alt="" >}}
