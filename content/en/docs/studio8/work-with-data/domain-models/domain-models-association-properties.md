...
*  [Delete behavior](#delete-behavior)
   ...
   {{% image_container width="300" %}}{{< figure src="/attachments/studio8/work-with-data/domain-models/domain-models-association-properties/association-properties.png" alt="" >}}
   {{% /image_container %}}
...
{{% image_container width="400" %}}{{< figure src="/attachments/studio8/work-with-data/domain-models/domain-models-association-properties/association-domainmodel.png" alt="" >}}
{{% /image_container %}}
...
*  An icon next to the entity that has such association: 
   ...
   {{< figure src="/attachments/studio8/work-with-data/domain-models/domain-models-association-properties/association-icon.png" alt="" >}}

*  A pop-up window, which displays when you click the icon:

   {{< figure src="/attachments/studio8/work-with-data/domain-models/domain-models-association-properties/association-pop-up.png" alt="" >}}
