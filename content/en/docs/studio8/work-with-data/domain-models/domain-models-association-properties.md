...
*  [Delete behavior](#delete-behavior)
   ...
   {{% image_container width="300" %}}{{< figure src="/attachments/studio8/work-with-data/domain-models/domain-models-association-properties/association-properties.png" >}}
   {{% /image_container %}}
...
{{% image_container width="400" %}}{{< figure src="/attachments/studio8/work-with-data/domain-models/domain-models-association-properties/association-domainmodel.png" >}}
{{% /image_container %}}
