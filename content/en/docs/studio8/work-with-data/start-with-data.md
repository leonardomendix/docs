...
{{< figure src="/attachments/studio8/work-with-data/start-with-data/drag-and-drop.png" alt="" >}}
{{% /image_container %}}
...
{{< figure src="/attachments/studio8/work-with-data/start-with-data/data-preview.png" alt="" >}}
...
{{< figure src="/attachments/studio8/work-with-data/start-with-data/manage-relations.png" alt="" >}}
{{% /image_container %}}
...
{{< figure src="/attachments/studio8/work-with-data/start-with-data/attribute-type-drop-down.png" alt="" >}}
...
{{< figure src="/attachments/studio8/work-with-data/start-with-data/generate-pages-option.png" alt="" >}}
...
{{% image_container width="350" %}}{{< figure src="/attachments/studio8/work-with-data/start-with-data/domain-model-example.png" alt="" >}}
{{% /image_container %}}
...
* A *Manage_Data* page is created – an overview page with tabs for each Excel table and with data grids per each entity
    ...
    {{< figure src="/attachments/studio8/work-with-data/start-with-data/manage-data-page.png" alt="" >}}
...
* A link from the *HomePage* is created – a card with buttons linking to the *Manage_Data* page   
    ...
    {{< figure src="/attachments/studio8/work-with-data/start-with-data/home-page.png" alt="" >}}
