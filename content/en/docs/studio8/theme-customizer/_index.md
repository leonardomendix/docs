...
{{% image_container width="250" %}}{{< figure src="/attachments/studio8/theme-customizer/logo-colors.png" alt="Logo Colors" >}}
{{% /image_container %}}
...
{{< figure src="/attachments/studio8/theme-customizer/brand-colors-style-dependency.png" alt="" >}}
...
{{% image_container width="250" %}}{{< figure src="/attachments/studio8/theme-customizer/widget-view.png" alt="Widget View" >}}
{{% /image_container %}}
...
2.  Click this setting and pick a color by doing one of the following:
	...
	{{% image_container width="200" %}}{{< figure src="/attachments/studio8/theme-customizer/adjusting-color.png" alt="Brand Colors and Logo Colors" >}}
    {{% /image_container %}}
