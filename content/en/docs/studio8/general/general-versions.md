...
{{% image_container width="500" %}}{{< figure src="/attachments/studio8/general/general-versions/about-dialog.png" >}}
{{% /image_container %}}
...
{{< figure src="/attachments/studio8/general/general-versions/top-bar-upgrade.png" >}}
