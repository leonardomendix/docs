...
{{% image_container width="350" %}}{{< figure src="/attachments/studio8/page-editor/page-editor-widgets/page-editor-widgets-input-elements/text-box-example.png" >}}
{{% /image_container %}}
...
{{< figure src="/attachments/studio8/page-editor/page-editor-widgets/page-editor-widgets-input-elements/Validation-type-required.png" >}}
{{% /image_container %}}
