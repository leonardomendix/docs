...
{{% image_container width="300" %}}{{< figure src="/attachments/studio8/page-editor/page-editor-widgets/widgets-examples.png" >}}
{{% /image_container %}}
...
{{% image_container width="350" %}}{{< figure src="/attachments/studio8/page-editor/page-editor-widgets/widgets-categories.png" >}}
{{% /image_container %}}
...
2.  Do one of the following: <br />
    ...
    {{% image_container width="300" %}}{{< figure src="/attachments/studio8/page-editor/page-editor-widgets/view-app-store-widgets.png" >}}
    {{% /image_container %}}<br />
