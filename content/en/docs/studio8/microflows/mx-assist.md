...
{{< figure src="/attachments/studio8/microflows/mx-assist/mx-assist-recommendations.png"   width="350"  >}}
...
{{< figure src="/attachments/studio8/microflows/mx-assist/info-icon-setting.png"   width="300"  >}}
...
3.  Click the selected activity to add it to the flow.
    ...
    {{< figure src="/attachments/studio8/microflows/mx-assist/mx-assist-list.png"   width="350"  >}}
...
{{< figure src="/attachments/studio8/microflows/mx-assist/check-added.png"   width="300"  >}}
...
2.  Find **Add a check** in the suggestions.
    ...
    {{< figure src="/attachments/studio8/microflows/mx-assist/adding-check.png"   width="350"  >}}
...
2. Find **Add a decision** in the suggestions and select it.
    ...
    {{< figure src="/attachments/studio8/microflows/mx-assist/adding-decision.png"   width="350"  >}}
