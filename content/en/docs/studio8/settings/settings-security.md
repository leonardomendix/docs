...
2. If your app has been created in the Developer Portal with Mendix version below 7.23.3, or has been labelled as private content, or has been customized by your team specifically for your company, the security state depends on Studio Pro:<br/>
	...
	{{% image_container width="400" %}}![Secure Your App Pop-up Window](/attachments/studio8/settings/settings-security/security-pop-up.png)
	{{% /image_container %}}<br/>
    ...
    ![](/attachments/studio8/settings/settings-security/roles-and-permissions-screen.png)
    ...
    ![](/attachments/studio8/settings/settings-security/security-read-only.png)
...
![The Page Access Tab Example](/attachments/studio8/settings/settings-security/page-access-tab.png)
...
2.  Click **Add Role** in the right corner.
    ...
    ![](/attachments/studio8/settings/settings-security/add-role-button.png)

3.  Specify the name of the new role in the **Create Role** dialog box and click **Create**.

    ![Create Role Dialog Box](/attachments/studio8/settings/settings-security/create-role-dialog.png)
...
2.  Click the **More Options** icon and select **Edit**.
    ...
    ![](/attachments/studio8/settings/settings-security/edit-role-option.png)

3.  In the **Edit Role** pop-up dialog perform the changes, and click **Save**.

    ![](/attachments/studio8/settings/settings-security/edit-role-dialog.png)    
...
2.  Click the **More Options** icon and select **Delete**.
    ...
    ![](/attachments/studio8/settings/settings-security/delete-role-option.png)

3.  Confirm the deletion in the pop-up dialog.

    ![](/attachments/studio8/settings/settings-security/delete-role-dialog.png)
...
1.  To set access via **Roles and Permissions**, do the following:<br/>
    ...
    ![](/attachments/studio8/settings/settings-security/page-access-example.png)
...
2.  To set access for a page/microflow via properties of this page/microflow , do the following: <br/>
	...
	![](/attachments/studio8/settings/settings-security/permissions-section.png)
...
2. Click a user icon in the right side of the screen:
    ...
    ![](/attachments/studio8/settings/settings-security/user-icon.png)

4. In the displayed menu bar, select a demo user and the app will be viewed from the perspective of the corresponding role.

    ![](/attachments/studio8/settings/settings-security/select-user.png)
...
![](/attachments/studio8/settings/settings-security/manage-users-button.png)
...
![Upgrade Required](/attachments/studio8/settings/settings-security/upgrade.png)
{{% /image_container %}}
