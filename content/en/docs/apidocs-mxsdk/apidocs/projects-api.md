...
{{< figure src="/attachments/apidocs-mxsdk/apidocs/projects-api/CreateNewAppCall.PNG" alt="" >}}
...
{{< figure src="/attachments/apidocs-mxsdk/apidocs/projects-api/call-create-new-app.png" alt="" >}}
...
{{< figure src="/attachments/apidocs-mxsdk/apidocs/projects-api/RetrieveJobStatusCall.PNG" alt="" >}}

#### 3.2.2 Output

The output of the RetrieveJobStatus operation is a `JobStatus` entity with the following attributes:

{{< figure src="/attachments/apidocs-mxsdk/apidocs/projects-api/RetrieveJobStatusResponse.PNG" alt="" >}}
...
{{< figure src="/attachments/apidocs-mxsdk/apidocs/projects-api/call-retrieve-job-status.png" alt="" >}}
...
{{< figure src="/attachments/apidocs-mxsdk/apidocs/projects-api/expose-team-server-revision.png" alt="" >}}
...
{{< figure src="/attachments/apidocs-mxsdk/apidocs/projects-api/commit-working-copy.png" alt="" >}}
