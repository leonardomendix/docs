...
{{< figure src="/attachments/studio/microflows/microflows-loop/loop.png" alt="" >}}
...
3. As you have retrieved the list of orders you can work on, you now need to create a loop and logic for it. Do the following: <br />
    ...
    {{< figure src="/attachments/studio/microflows/microflows-loop/loop-added.png" alt="Loop is Added" >}}<br />
...
5. In the **Change value** dialogue window, do the following:<br />
    ...
    {{< figure src="/attachments/studio/microflows/microflows-loop/change-value-dialogue-example.png" alt="Example of Change Value Dialogue Window" >}}
