...
{{< figure src="/attachments/studio/work-with-data/data-filters/retrieve-from-database.png" >}}
{{% /image_container %}}
...
{{% image_container width="300" %}}
{{< figure src="/attachments/studio/work-with-data/data-filters/page-database.jpg" >}}
{{% /image_container %}}
...
2. Click the **Filter** field.
    ...
    {{% image_container width="300" %}}{{< figure src="/attachments/studio/work-with-data/data-filters/filter-field.png" >}}{{% /image_container %}}
