...
![](/attachments/studio/work-with-data/start-with-data/drag-and-drop.png)
{{% /image_container %}}
...
![](/attachments/studio/work-with-data/start-with-data/data-preview.png)
...
![](/attachments/studio/work-with-data/start-with-data/manage-relations.png)
{{% /image_container %}}
...
![](/attachments/studio/work-with-data/start-with-data/attribute-type-drop-down.png)
...
![](/attachments/studio/work-with-data/start-with-data/generate-pages-option.png)
...
{{% image_container width="350" %}}![](/attachments/studio/work-with-data/start-with-data/domain-model-example.png)
{{% /image_container %}}
...
* A *Manage_Data* page is created – an overview page with tabs for each Excel table and with data grids per each entity
    ...
    ![](/attachments/studio/work-with-data/start-with-data/manage-data-page.png)
...
* A link from the *HomePage* is created – a card with buttons linking to the *Manage_Data* page   
    ...
    ![](/attachments/studio/work-with-data/start-with-data/home-page.png)
