...
{{< figure src="/attachments/studio/work-with-data/start-with-data/drag-and-drop.png" >}}
{{% /image_container %}}
...
{{< figure src="/attachments/studio/work-with-data/start-with-data/manage-relations.png" >}}
{{% /image_container %}}
...
{{% image_container width="350" %}}{{< figure src="/attachments/studio/work-with-data/start-with-data/domain-model-example.png" >}}
{{% /image_container %}}
