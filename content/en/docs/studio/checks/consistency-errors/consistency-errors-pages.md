...
2. Open properties for the **Details** button > the **Events** section and enable the **Create Object** option.
     ...
     {{% image_container width="350" %}}![Create Object Option Enabled](/attachments/studio/checks/consistency-errors/consistency-errors-pages/create-object-option-enabled.png)
     {{% /image_container %}}
...
{{% image_container width="350" %}}![A Button on Engineers Page](/attachments/studio/checks/consistency-errors/consistency-errors-pages/engineers-page.png)
{{% /image_container %}}
...
{{% image_container width="350" %}}![List View on the Tasks Page](/attachments/studio/checks/consistency-errors/consistency-errors-pages/tasks-page-list-view.png)
{{% /image_container %}}
...
![On Click Action Error](/attachments/studio/checks/consistency-errors/consistency-errors-pages/on-click-action-error.png)
