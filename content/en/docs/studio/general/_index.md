...
![Studio Diagram](/attachments/studio/general/home-page.png)
...
![Edit in Studio](/attachments/studio/general/edit-app.jpg)
{{% /image_container %}}
...
2.  Click the globe icon in the top right corner (only available if Studio is enabled).
	...
	![Globe Icon](/attachments/studio/general/globe-icon.png)
...
{{% image_container width="350" %}}![Upgrade](/attachments/studio/general/upgrade.png)
{{% /image_container %}}
...
* Responsive (Desktop) 
    ...
    {{% image_container width="300" %}}![Device Modes](/attachments/studio/general/view.png)
    {{% /image_container %}}
...
![Left Menu Bar](/attachments/studio/general/left-menu-bar.png)
{{% /image_container %}}
...
![Toolbox, Properties, Buzz](/attachments/studio/general/toolbox-properties-buzz.png)
