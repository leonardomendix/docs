...
{{< figure src="/attachments/studio/general/edit-app.jpg" alt="Edit in Studio" >}}
{{% /image_container %}}
...
{{% image_container width="350" %}}{{< figure src="/attachments/studio/general/upgrade.png" alt="Upgrade" >}}
{{% /image_container %}}
...
* Responsive (Desktop) 
    ...
    {{% image_container width="300" %}}{{< figure src="/attachments/studio/general/view.png" alt="Device Modes" >}}
    {{% /image_container %}}
...
{{< figure src="/attachments/studio/general/left-menu-bar.png" alt="Left Menu Bar" >}}
{{% /image_container %}}
