...
2. In the **Roles and Permissions** screen, click **Enable Security**:
	...
	{{% image_container width="550" %}}{{< figure src="/attachments/studio-how-to8/security-how-to-configure-roles/enable-security.png" alt="Enable Security" >}}{{% /image_container %}}
...
6. In the **Create Role** dialog box, fill in the role name as **Front_Desk** and click **Save**:
    ...
    {{% image_container width="450" %}}{{< figure src="/attachments/studio-how-to8/security-how-to-configure-roles/create-role.png" alt="Create Role" >}}{{% /image_container %}}
...
4. In the displayed menu bar, select a demo user and the app will be viewed from the perspective of the corresponding role. Click the **demo_customer** to test which functionality can the **Customer** role view and access.
    ...
    {{% image_container width="350" %}}{{< figure src="/attachments/studio-how-to8/security-how-to-configure-roles/select-user.png" alt="Select Demo User" >}}{{% /image_container %}}
