...
{{< figure src="/attachments/howto8/general/minimize-number/object_flow.png" alt="" >}}
...
{{< figure src="/attachments/howto8/general/minimize-number/domain_model_npe.png" alt="" >}}

Then link the object to the current session when you create it in a microflow:

{{< figure src="/attachments/howto8/general/minimize-number/create_object_dialog.png" alt="" >}}
