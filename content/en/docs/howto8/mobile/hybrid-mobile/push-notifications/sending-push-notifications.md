...
1.  Locate the **Online_Snippet** or **Offline_Snippet** document and open it.
	...
	{{< figure src="/attachments/howto8/mobile/hybrid-mobile/push-notifications/sending-push-notifications/push_notifications_snippets.png" alt="" >}}

2. Double-click the widget to open the properties.

	{{< figure src="/attachments/howto8/mobile/hybrid-mobile/push-notifications/sending-push-notifications/push_notifications_widget_settings.png" alt="" >}}
...
{{< figure src="/attachments/howto8/mobile/hybrid-mobile/push-notifications/sending-push-notifications/push_notifications_action.png" alt="" >}}
