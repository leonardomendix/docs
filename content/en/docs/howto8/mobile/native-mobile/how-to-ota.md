...
1.  Navigate to **App Capabilities**: 
	...
	{{% image_container width="350" %}}{{< figure src="/attachments/howto8/mobile/native-mobile/how-to-ota/advanced-capabilities.png" alt="Start Mendix Native Mobile Builder" >}}{{% /image_container %}}

1.  Toggle **App Center CodePush OTA Support** on: 

	{{% image_container width="350" %}}{{< figure src="/attachments/howto8/mobile/native-mobile/how-to-ota/advanced-capabilities-ota.png" alt="OTA capability enabled" >}}{{% /image_container %}}

1. Click **Save**.
1.  Now build an application for distribution and make a note of the version number used: 

	{{% image_container width="350" %}}{{< figure src="/attachments/howto8/mobile/native-mobile/how-to-ota/build-release-app-for-ota.png" alt="Build release app page" >}}{{% /image_container %}}
...
{{% image_container width="300" %}}{{< figure src="/attachments/howto8/mobile/native-mobile/build-native-apps/use-cli-docs/how-to-ota-cli/phone-error-text.png" alt="Typo in welcome screen" >}}{{% /image_container %}}
...
1.  Correct the title and message as follows:
	...
	{{% image_container width="300" %}}{{< figure src="/attachments/howto8/mobile/native-mobile/build-native-apps/use-cli-docs/how-to-ota-cli/modeller-correct.png" alt="Make some changes" >}}{{% /image_container %}}
...
1.  Under **Build app for distribution**, select **Deploy OTA update via CodePush**:
	...
	{{% image_container width="350" %}}{{< figure src="/attachments/howto8/mobile/native-mobile/how-to-ota/advanced-ota-menu.png" alt="Menu entry Deploy OTA update via CodePush" >}}{{% /image_container %}}
...
1.  Type in the target app version you wish to release the OTA update for. This version needs to match exactly with the app version used for building the app binaries in the previous step, or the one released on the app stores:
	...
	{{% image_container width="350" %}}{{< figure src="/attachments/howto8/mobile/native-mobile/how-to-ota/advanced-ota-configuration.png" alt="OTA configuration screen" >}}{{% /image_container %}}
...
1.  The Mendix Native Mobile Builder will compile your app and resources and release the OTA updates:
	...
	{{% image_container width="350" %}}{{< figure src="/attachments/howto8/mobile/native-mobile/how-to-ota/advanced-ota-building.png" alt="OTA build step" >}}{{% /image_container %}}

1.  On compilation you will receive links to the CodePush OTA update administration pages for your Android and iOS apps:

	{{% image_container width="350" %}}{{< figure src="/attachments/howto8/mobile/native-mobile/how-to-ota/advanced-ota-success.png" alt="OTA build step success" >}}{{% /image_container %}}

	{{% image_container width="350" %}}{{< figure src="/attachments/howto8/mobile/native-mobile/how-to-ota/advanced-ota-appcenter-page.png" alt="OTA App Center page" >}}{{% /image_container %}}
...
2. Restart the app on your testing device. You should be greeted with the following message:
	...
	{{% image_container width="300" %}}{{< figure src="/attachments/howto8/mobile/native-mobile/build-native-apps/use-cli-docs/how-to-ota-cli/phone-update-prompt.png" alt="Update available prompt" >}}{{% /image_container %}}

3.  Tap **Confirm** to update your app.
4.  The app should reload and greet you with the following dialog box:

	{{% image_container width="300" %}}{{< figure src="/attachments/howto8/mobile/native-mobile/build-native-apps/use-cli-docs/how-to-ota-cli/phone-success-prompt.png" alt="Update success prompt" >}}{{% /image_container %}}
