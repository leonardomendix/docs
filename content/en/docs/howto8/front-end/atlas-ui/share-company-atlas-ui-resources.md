...
{{< figure src="/attachments/howto8/front-end/atlas-ui/share-company-atlas-ui-resources/sharing_export_uiresources.png" alt="" >}}
...
{{< figure src="/attachments/howto8/front-end/atlas-ui/share-company-atlas-ui-resources/sharing_appstore_addcontent.png" alt="" >}}
...
1.  Select the **Blank App** and open the new app in Studio Pro:
    ...
    {{< figure src="/attachments/howto8/front-end/atlas-ui/share-company-atlas-ui-resources/sharing_createnewapp.png" alt="" >}}
...
2. Expand at the **App Store modules** at the Mendix **Project** level and find the default **Atlas_UI_Resources** module. Right-click this module and delete it:
    ...
    {{< figure src="/attachments/howto8/front-end/atlas-ui/share-company-atlas-ui-resources/sharing_delete_module.png" alt="" >}}
...
{{< figure src="/attachments/howto8/front-end/atlas-ui/share-company-atlas-ui-resources/sharing_appstore_addcontent_starterapp.png" alt="" >}}

These are examples of app impression images:

{{< figure src="/attachments/howto8/front-end/atlas-ui/share-company-atlas-ui-resources/sharing_createnewapp_detail.png" alt="" >}}
...
1.  Open the Mendix Marketplace in Studio Pro and then select **UI Resources** in the left sidebar **Categories** menu:
    ...
    {{< figure src="/attachments/howto8/front-end/atlas-ui/share-company-atlas-ui-resources/sharing.png" alt="" >}}
...
2. Select the UI resources that have been created by your company:
    ...
    {{< figure src="/attachments/howto8/front-end/atlas-ui/share-company-atlas-ui-resources/sharing_detail.png" alt="" >}}
