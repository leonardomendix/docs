...
3.  Create a **Microflow** that creates a customer and returns a Boolean. 
	...
	{{< figure src="/attachments/howto8/testing/testing-web-services-using-soapui/model1.jpg" alt="" >}}

4.  Create a **Microflow** that deletes a customer and returns a Boolean.

	{{< figure src="/attachments/howto8/testing/testing-web-services-using-soapui/model2.jpg" alt="" >}}
...
2.  Press **CTRL+N** to create a new SOAP project.
    {{< figure src="/attachments/howto8/testing/testing-web-services-using-soapui/18580339.png" alt="" >}}
3.  Run the project locally in Studio Pro.
4.  Go to `http://localhost:8080/ws-doc/`.
    {{< figure src="/attachments/howto8/testing/testing-web-services-using-soapui/18580314.png" alt="" >}}
5.  Enter the URL of the WSDL schema in the **Initial WSDL** field in SoapUI.
    ...
    {{< figure src="/attachments/howto8/testing/testing-web-services-using-soapui/18580334.png" alt="" >}}
6.  Click** OK**. This will create a new SOAP project in SoapUI.
    {{< figure src="/attachments/howto8/testing/testing-web-services-using-soapui/18580313.png" alt="" >}}
...
1. In SoapUI, press **CTRL+T** to create a new TestSuite.
   {{< figure src="/attachments/howto8/testing/testing-web-services-using-soapui/18580332.png" alt="" >}}
2. Click **OK**.
3. Select TestSuite 1 and press **CTRL+N** to create a new TestCase.
   {{< figure src="/attachments/howto8/testing/testing-web-services-using-soapui/18580331.png" alt="" >}}
4. Click **OK**.
5. Expand TestSuite 1 and TestCase 1.
6. Right-click **Test Steps(0)** and select **SOAP Request**.
   {{< figure src="/attachments/howto8/testing/testing-web-services-using-soapui/18580312.png" alt="" >}}
7. Enter _Retrieve Customers_ in the name field.
   {{< figure src="/attachments/howto8/testing/testing-web-services-using-soapui/18580329.png" alt="" >}}
8. Click **OK**.
9. Select **CustomerWebserviceSoap -> GetCustomers**.
   {{< figure src="/attachments/howto8/testing/testing-web-services-using-soapui/18580328.png" alt="" >}}
10. Click **OK**.
    {{< figure src="/attachments/howto8/testing/testing-web-services-using-soapui/18580327.png" alt="" >}}
11. Click **OK**.
12. Open SOAP request **Retrieve Customers**.
    {{< figure src="/attachments/howto8/testing/testing-web-services-using-soapui/18580326.png" alt="" >}} 
...
1.  Click **Assertions (1)**.
    {{< figure src="/attachments/howto8/testing/testing-web-services-using-soapui/18580307.png" alt="" >}}
...
2.  Click the add assertion icon.
    {{< figure src="/attachments/howto8/testing/testing-web-services-using-soapui/18580324.png" alt="" >}}
...
6.  In step 1.4 of the previous how-to you have added some data. Enter the number of created customers in the **Expected Result** field. In this example four customers were created.
    {{< figure src="/attachments/howto8/testing/testing-web-services-using-soapui/18580323.png" alt="" >}}
7.  Click **Save**.
...
3.  Add a **Contains Assertion** and enter _true_ in the content field.
    {{< figure src="/attachments/howto8/testing/testing-web-services-using-soapui/18580322.png" alt="" >}} 
4.  Right-click test step **Retrieve Customers**.

5.  Select **Clone TestStep**.

6.  Change **TestStep Name** to _Retrieve Customers 2_.
    {{< figure src="/attachments/howto8/testing/testing-web-services-using-soapui/18580320.png" alt="" >}}
7.  Click **OK**.
...
1.  Open testcase **TestCase 1**.
    {{< figure src="/attachments/howto8/testing/testing-web-services-using-soapui/18580310.png" alt="" >}}
2.  Click the run this testcase icon.
    {{< figure src="/attachments/howto8/testing/testing-web-services-using-soapui/18580309.png" alt="" >}}
