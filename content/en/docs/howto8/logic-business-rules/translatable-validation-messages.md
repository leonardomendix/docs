...
{{< figure src="/attachments/howto8/logic-business-rules/translatable-validation-messages/18581628.png" alt="" >}}
...
{{< figure src="/attachments/howto8/logic-business-rules/translatable-validation-messages/18581627.png" alt="" >}}
...
{{< figure src="/attachments/howto8/logic-business-rules/translatable-validation-messages/18581626.png" alt="" >}}
...
{{< figure src="/attachments/howto8/logic-business-rules/translatable-validation-messages/18581625.png" alt="" >}}

Create an enumeration containing all validation messages

{{< figure src="/attachments/howto8/logic-business-rules/translatable-validation-messages/18581624.png" alt="" >}}

Reference the model below for messages you should store in the entity:

{{< figure src="/attachments/howto8/logic-business-rules/translatable-validation-messages/model1.jpg" alt="" >}}

{{< figure src="/attachments/howto8/logic-business-rules/translatable-validation-messages/model2.jpg" alt="" >}}
...
{{< figure src="/attachments/howto8/logic-business-rules/translatable-validation-messages/model3.jpg" alt="" >}}
...
{{< figure src="/attachments/howto8/logic-business-rules/translatable-validation-messages/model4.jpg" alt="" >}}
