...
{{< figure src="/attachments/howto8/monitoring-troubleshooting/detect-and-resolve-performance-issues/18580226.png" alt="" >}}
...
{{< figure src="/attachments/howto8/monitoring-troubleshooting/detect-and-resolve-performance-issues/18580222.png" alt="" >}}

To set up a timer, first add a **Create variable** activity as the first step, where you are going to store the current time:

{{< figure src="/attachments/howto8/monitoring-troubleshooting/detect-and-resolve-performance-issues/18580221.png" alt="" >}}

Then, add a **Log message** activity at the end of your microflow:

{{< figure src="/attachments/howto8/monitoring-troubleshooting/detect-and-resolve-performance-issues/18580219.png" alt="" >}}

Set up the activity similar to this:

{{< figure src="/attachments/howto8/monitoring-troubleshooting/detect-and-resolve-performance-issues/18580220.png" alt="" >}}
...
{{< figure src="/attachments/howto8/monitoring-troubleshooting/detect-and-resolve-performance-issues/18580216.png" alt="" >}}
...
{{< figure src="/attachments/howto8/monitoring-troubleshooting/detect-and-resolve-performance-issues/18580218.png" alt="" >}}
...
{{< figure src="/attachments/howto8/monitoring-troubleshooting/detect-and-resolve-performance-issues/18580217.png" alt="" >}}
