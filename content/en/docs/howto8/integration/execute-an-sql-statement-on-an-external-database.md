...
1. Find the **Database Connector** in the **Toolbox**.
	...
	{{< figure src="/attachments/howto8/integration/execute-an-sql-statement-on-an-external-database/19399122.png" alt="" >}}

2. Drag the **Execute statement** action to your microflow: 

	{{< figure src="/attachments/howto8/integration/execute-an-sql-statement-on-an-external-database/19399123.png" alt="" >}}
...
3. Configure the statement:
	...
	* Specify the **Output Variable name**
	...
	{{< figure src="/attachments/howto8/integration/execute-an-sql-statement-on-an-external-database/19399146.png" alt="" >}}
