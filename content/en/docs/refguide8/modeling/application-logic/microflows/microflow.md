...
{{% image_container width="250" %}}{{< figure src="/attachments/refguide8/modeling/application-logic/microflows/microflow/microflow-properties.png" alt="Microflow Properties" >}}
{{% /image_container %}}
