...
![Selecting Group objects through an input reference set selector in a Customer data view](/attachments/refguide8/modeling/domain-model/associations/association-member-properties/input-reference-set-selector.png)
