...
![Picture of a persistable and a non-persistable entity](/attachments/refguide8/modeling/domain-model/entities/persistability/persistable-vs-non-persistable.png)
