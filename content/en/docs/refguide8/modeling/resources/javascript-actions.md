...
{{% image_container width="400" %}}![javascript settings](/attachments/refguide8/modeling/resources/javascript-actions/javascript-action-settings-no-para.png){{% /image_container %}}
...
![parameter](/attachments/refguide8/modeling/resources/javascript-actions/parameter-naming.png)
...
![parameter code](/attachments/refguide8/modeling/resources/javascript-actions/parameter-code.png)
...
{{% image_container width="400" %}}![call javascript action dialog](/attachments/refguide8/modeling/resources/javascript-actions/call-js-action-dialog.png){{% /image_container %}}
...
{{% image_container width="450" %}}![type parameter](/attachments/refguide8/modeling/resources/javascript-actions/type-parameter.png){{% /image_container %}}
...
{{% image_container width="450" %}}![expose action](/attachments/refguide8/modeling/resources/javascript-actions/expose-jsaction.png){{% /image_container %}}
...
![workshop exposed](/attachments/refguide8/modeling/resources/javascript-actions/workshop-exposed.png)
...
{{% image_container width="450" %}}![documentation](/attachments/refguide8/modeling/resources/javascript-actions/documentation-pro.png){{% /image_container %}}
...
{{% image_container width="450" %}}![documentation js file](/attachments/refguide8/modeling/resources/javascript-actions/documentation-js-file.png){{% /image_container %}}
