...
* **Area** chart – a line chart with a fill to the X-axis {{% image_container width="200" %}}{{< figure src="/attachments/refguide8/modeling/pages/chart-widgets/sample-area-chart.png" alt="Sample Area Chart" >}}{{% /image_container %}}
...
{{% image_container width="400" %}}{{< figure src="/attachments/refguide8/modeling/pages/chart-widgets/contour.png" alt="Sample Contour Chart made with Any Chart" >}}{{% /image_container %}}
