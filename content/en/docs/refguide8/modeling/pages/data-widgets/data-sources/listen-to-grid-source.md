...
{{% image_container width="400" %}}{{< figure src="/attachments/refguide8/modeling/pages/data-widgets/data-sources/listen-to-grid-source/listen-to-widget-example.jpg" alt="Listen to Widget Example" >}}
{{% /image_container %}}
