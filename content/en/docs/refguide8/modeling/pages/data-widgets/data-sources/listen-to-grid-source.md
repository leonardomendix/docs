...
{{% image_container width="400" %}}![Listen to Widget Example](/attachments/refguide8/modeling/pages/data-widgets/data-sources/listen-to-grid-source/listen-to-widget-example.jpg)
{{% /image_container %}}
