...
{{< figure src="/attachments/refguide8/modeling/pages/data-widgets/grids/template-grid/template-grid.png" alt="" >}}
...
{{% image_container width="250" %}}{{< figure src="/attachments/refguide8/modeling/pages/data-widgets/grids/template-grid/template-grid-properties.png" alt="" >}}
{{% /image_container %}}
