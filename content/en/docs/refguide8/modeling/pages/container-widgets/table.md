...
{{< figure src="/attachments/refguide8/modeling/pages/container-widgets/table/table.png" alt="" >}}
...
{{% image_container width="250" %}}{{< figure src="/attachments/refguide8/modeling/pages/container-widgets/table/table-properties.png" alt="Table Properties" >}}
{{% /image_container %}}
