...
{{% image_container width="400" %}}{{< figure src="/attachments/refguide8/modeling/pages/page-resources/snippet/snippet.png" alt="Example of a snippet" >}}
{{% /image_container %}}
...
{{% image_container width="250" %}}{{< figure src="/attachments/refguide8/modeling/pages/page-resources/snippet/snippet-properties.png" alt="Example of the snippet properties pane" >}}
{{% /image_container %}}
