...
{{< figure src="/attachments/refguide8/modeling/pages/page-resources/layout/header/header-layout.png" alt="" >}}
...
{{% image_container width="350" %}}{{< figure src="/attachments/refguide8/modeling/pages/page-resources/layout/header/header-page.png" alt="" >}}
{{% /image_container %}}
...
{{% image_container width="250" %}}{{< figure src="/attachments/refguide8/modeling/pages/page-resources/layout/header/header-properties.png" alt="" >}}
{{% /image_container %}}
