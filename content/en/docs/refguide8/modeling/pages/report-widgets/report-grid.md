...
{{% image_container width="300" %}}{{< figure src="/attachments/refguide8/modeling/pages/report-widgets/report-grid/report-grid-properties.png" alt="Report grid in structure mode" >}}
{{% /image_container %}}
...
{{% image_container width="250" %}}{{< figure src="/attachments/refguide8/modeling/pages/report-widgets/report-grid/report-grid-column-properties.png" alt="Report grid column properties" >}}
{{% /image_container %}}
