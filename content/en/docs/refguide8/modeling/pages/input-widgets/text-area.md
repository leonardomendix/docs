...
![](/attachments/refguide8/modeling/pages/input-widgets/text-area/text-area.png)

## 2 Properties

An example of text area properties is represented in the image below:

{{% image_container width="250" %}}![](/attachments/refguide8/modeling/pages/input-widgets/text-area/text-area-properties.png)
{{% /image_container %}}
...
![](/attachments/refguide8/modeling/pages/input-widgets/text-area/counter-message.png)
