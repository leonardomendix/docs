...
{{< figure src="/attachments/refguide8/modeling/pages/input-widgets/drop-down/drop-down.png" alt="" >}}

## 2 Properties

An example of drop-down properties is represented in the image below:

{{% image_container width="300" %}}{{< figure src="/attachments/refguide8/modeling/pages/input-widgets/drop-down/drop-down-properties.png" alt="" >}}
{{% /image_container %}}
...
{{< figure src="/attachments/refguide8/modeling/pages/input-widgets/drop-down/select-a-region.png" alt="" >}}
