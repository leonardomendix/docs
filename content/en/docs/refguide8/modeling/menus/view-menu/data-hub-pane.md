...
{{% image_container width="300" %}}{{< figure src="/attachments/refguide8/modeling/menus/view-menu/data-hub-pane/data-hub-pane-empty.png" alt="data-hub-pane" >}}{{% /image_container %}}
...
{{% image_container width="300" %}}{{< figure src="/attachments/refguide8/modeling/menus/view-menu/data-hub-pane/project-section.png" alt="Project Section" >}}{{% /image_container %}}
...
{{% image_container width="300" %}}{{< figure src="/attachments/refguide8/modeling/menus/view-menu/data-hub-pane/filter-icon.png" alt="Filter Icon" >}}{{% /image_container %}}
...
* **Green check-mark** if the service or entity is consumed in the project. If you right-click a consumed service, you can do the following:
  ...
  {{% image_container width="250" %}}{{< figure src="/attachments/refguide8/modeling/menus/view-menu/data-hub-pane/data-hub-pane-menu.png" alt="info on a Service" >}}{{% /image_container %}}
...
* **Information icon** to view further details for the service and a link to go directly to the [Service Details](/data-hub/data-hub-catalog/search/#search-details) screen in the Data Hub Catalog:
  ...
  {{% image_container width="250" %}}{{< figure src="/attachments/refguide8/modeling/menus/view-menu/data-hub-pane/data-hub-pane-info.png" alt="Data Hub Pane Information" >}}{{% /image_container %}}
...
{{% image_container width="250" %}}{{< figure src="/attachments/refguide8/modeling/menus/view-menu/data-hub-pane/expand-service-list.png" alt="Data Hub Pane Information" >}}{{% /image_container %}}
...
{{% image_container width="250" %}}{{< figure src="/attachments/refguide8/modeling/menus/view-menu/data-hub-pane/multiple-assocs.png" alt="multiple associations" >}}{{% /image_container %}}
...
{{% image_container width="300" %}}{{< figure src="/attachments/refguide8/modeling/menus/view-menu/data-hub-pane/unsupported-attributes.png" alt="multiple associations" >}}{{% /image_container %}}
