...
![Warnings in the Errors pane](/attachments/refguide8/modeling/menus/view-menu/errors-pane/suppression-rules/errors-pane-with-warnings.png)
...
![The settings file shown in Windows Explorer](/attachments/refguide8/modeling/menus/view-menu/errors-pane/suppression-rules/windows-explorer-showing-settings-files.png)
...
![Suppressing a Warning](/attachments/refguide8/modeling/menus/view-menu/errors-pane/suppression-rules/suppressing-warning.png)
...
1.  Click the **Suppression rules** button in the **Errors** pane.
	...
	![Viewing the suppress warnings rules](/attachments/refguide8/modeling/menus/view-menu/errors-pane/suppression-rules/errors-pane-suppress-warnings-button.png)

2. In the **Manage Suppression Rules** dialog box, check the **Suppress warnings from Marketplace modules** option.

    ![Suppressing Marketplace warnings](/attachments/refguide8/modeling/menus/view-menu/errors-pane/suppression-rules/rules-dialog-app-store-setting.png)
...
2. In the **Manage Suppression Rules** dialog box, select the **New** button:
    ...
    ![Rules window - new button](/attachments/refguide8/modeling/menus/view-menu/errors-pane/suppression-rules/rules-dialog-new-button.png)
...
3. In the **Add Suppression Rule** dialog box, set the necessary options to add the rule (for more information on settings, see the [Rule Setting](#rule-settings) section.  
    ...
    ![Rules window - add suppression](/attachments/refguide8/modeling/menus/view-menu/errors-pane/suppression-rules/new-warning-window.png)
...
2.  In the **Manage Suppression Rules** dialog box, select the **Edit** button:
    ...
    ![Rules window - edit button](/attachments/refguide8/modeling/menus/view-menu/errors-pane/suppression-rules/rules-dialog-edit-button.png)
...
3.  In the **Edit Suppression Rule** dialog box, edit options to change the rule (for more information on settings, see the [Suppression Rule Settings](#rule-settings) section. 
    ...
    ![Rule settings window](/attachments/refguide8/modeling/menus/view-menu/errors-pane/suppression-rules/rule-settings-window.png)
...
2.   In the **Manage Suppression Rules** dialog box, click the **Delete** button:
    ...
    ![Rules window - delete button](/attachments/refguide8/modeling/menus/view-menu/errors-pane/suppression-rules/rules-dialog-delete-button.png)
...
2.  In the **Manage Suppression Rules** dialog box, select the **Import** button:
    ...
    ![Import rules button](/attachments/refguide8/modeling/menus/view-menu/errors-pane/suppression-rules/import-rules.png)
...
5.  In a confirmation pop-up window, click **OK** to dismiss it:
    ...
    ![Import rules confirmation](/attachments/refguide8/modeling/menus/view-menu/errors-pane/suppression-rules/confirmation-dialog-after-rules-imported.png)
...
2.  In the **Manage Suppression Rules** dialog box, select the **Export** button:
    ...
    ![Export rules button](/attachments/refguide8/modeling/menus/view-menu/errors-pane/suppression-rules/export-rules.png)
...
5.  In a confirmation pop-up window, click **OK** to dismiss it:
    ...
    ![Export rules confirmation](/attachments/refguide8/modeling/menus/view-menu/errors-pane/suppression-rules/confirmation-dialog-after-rules-exported.png)
