...
{{< figure src="/attachments/refguide8/runtime/runtime-java/2.jpg" alt="" >}}

Or as shown in the Mendix Cloud:

{{< figure src="/attachments/refguide8/runtime/runtime-java/4.jpg" alt="" >}}
...
{{< figure src="/attachments/refguide8/runtime/runtime-java/5.jpg" alt="" >}}
...
{{< figure src="/attachments/refguide8/runtime/runtime-java/6.jpg" alt="" >}}
...
* [Non-Persistable Objects & Garbage Collecting](/refguide8/transient-objects-garbage-collecting/)
* [Java Memory Usage](/refguide8/java-memory-usage/)
* [Common Runtime & Java Errors](/refguide8/runtime-java-errors/)
