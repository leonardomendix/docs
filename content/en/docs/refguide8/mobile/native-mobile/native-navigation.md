...
{{% image_container width="250" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-navigation/singlestack.gif" alt="" >}}{{% /image_container %}}
...
{{% image_container width="250" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-navigation/multiplestacks.gif" alt="" >}}{{% /image_container %}}
...
{{% image_container width="250" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-navigation/popups.gif" alt="" >}}{{% /image_container %}}
