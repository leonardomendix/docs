...
{{% image_container width="400" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/custom-class.png" alt="custom class" >}}{{% /image_container %}}
...
{{% image_container width="350" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/list-view.png" alt="list view" >}}{{% /image_container %}}
...
{{% image_container width="350" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/tab-container.png" alt="tab container" >}}{{% /image_container %}}
...
{{% image_container width="350" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/text-box.png" alt="text box" >}}{{% /image_container %}}
...
{{% image_container width="350" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/text-area.png" alt="text area" >}}{{% /image_container %}}
...
{{% image_container width="350" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/check-box.png" alt="check box" >}}{{% /image_container %}}
...
{{% image_container width="300" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/date-picker.png" alt="date picker" >}}{{% /image_container %}}
...
{{% image_container width="350" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/action-button.png" alt="action button" >}}{{% /image_container %}}
...
{{% image_container width="300" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/nav-widget.png" alt="navigation widget" >}}{{% /image_container %}}
...
{{% image_container width="350" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/activity-indicator.png" alt="activity indicator" >}}{{% /image_container %}}
...
{{% image_container width="350" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/badge.png" alt="badge" >}}{{% /image_container %}}
...
{{% image_container width="350" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/feedback-two.png" alt="feedback" >}}{{% /image_container %}}
...
{{% image_container width="350" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/maps.png" alt="maps" >}}{{% /image_container %}}
...
{{% image_container width="300" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/progress-bar.png" alt="progress bar" >}}{{% /image_container %}}
...
{{% image_container width="300" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/progress-circle.png" alt="progress circle" >}}{{% /image_container %}}
...
{{% image_container width="350" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/qr-code.png" alt="qr code" >}}{{% /image_container %}}
...
{{% image_container width="300" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/range-slider.png" alt="range slider" >}}{{% /image_container %}}
...
{{% image_container width="300" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/slider.png" alt="slider" >}}{{% /image_container %}}
...
{{% image_container width="350" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/ratings.png" alt="ratings" >}}{{% /image_container %}}
...
{{% image_container width="350" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/toggle-buttons.png" alt="toggle buttons" >}}{{% /image_container %}}
...
{{% image_container width="300" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/video-player.png" alt="video player" >}}{{% /image_container %}}
...
{{% image_container width="350" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/intro-screen.gif" alt="intro screen" >}}{{% /image_container %}}
...
{{% image_container width="350" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/list-view-swipe-buttons.gif" alt="list view swipe" >}}{{% /image_container %}}
...
* Modal bottom sheet:
	...
	{{% image_container width="350" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/modal-bottom-sheet.gif" alt="modal bottom sheet" >}}{{% /image_container %}}

* Expanding bottom sheet:

	{{% image_container width="350" %}}{{< figure src="/attachments/refguide8/mobile/native-mobile/native-styling-refguide/expanding-bottom-sheet.gif" alt="expanding bottom sheet" >}}{{% /image_container %}}
