...
Customized log messages are created by defining a template. The template is the structure of the log’s message, and can be composed of parameters and free text.
 ...
 {{< figure src="/attachments/howto7/monitoring-troubleshooting/log-levels/18580031.png" alt="" >}}
...
| Warning | {{< figure src="/attachments/howto7/monitoring-troubleshooting/log-levels/18580038.png" alt="" >}} | Orange | Indicates that something unexpected happened or that there is some problem in the near future (for example, "disk space low"). The application is still working as expected. |
| Error | {{< figure src="/attachments/howto7/monitoring-troubleshooting/log-levels/18580037.png" alt="" >}} | Red | Due to a more serious problem, the application has not been able to perform some function. |
| Critical | {{< figure src="/attachments/howto7/monitoring-troubleshooting/log-levels/18580036.png" alt="" >}} | White (text), red (background) | A serious error has occurred, indicating that the application itself may be unable to continue running. |
...
{{< figure src="/attachments/howto7/monitoring-troubleshooting/log-levels/18580030.png" alt="" >}}
...
{{< figure src="/attachments/howto7/monitoring-troubleshooting/log-levels/18580029.png" alt="" >}}
...
{{< figure src="/attachments/howto7/monitoring-troubleshooting/log-levels/18580028.png" alt="" >}}
