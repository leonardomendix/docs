...
{{< figure src="/attachments/howto7/monitoring-troubleshooting/clear-warning-messages/18579992.png" alt="" >}}

If this tab is not visible, it can be displayed via the **View** menu by selecting the **Error List** option:

{{< figure src="/attachments/howto7/monitoring-troubleshooting/clear-warning-messages/18579991.png" alt="" >}}
