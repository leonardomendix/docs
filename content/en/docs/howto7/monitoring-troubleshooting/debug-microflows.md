...
{{< figure src="/attachments/howto7/monitoring-troubleshooting/debug-microflows/18580004.png" alt="" >}}
...
{{< figure src="/attachments/howto7/monitoring-troubleshooting/debug-microflows/18580017.png" alt="" >}}

The **Debugger** pane is useful when you are debugging your microflow, as it will walk you through the microflow:

{{< figure src="/attachments/howto7/monitoring-troubleshooting/debug-microflows/18580008.png" alt="" >}}
...
{{< figure src="/attachments/howto7/monitoring-troubleshooting/debug-microflows/18580005.png" alt="" >}}
...
3. Right-click any of the activities or splits in the microflow and select **Add breakpoint**. This sets a breakpoint on the selected step in the microflow, which is visually represented by a red dot:
    {{< figure src="/attachments/howto7/monitoring-troubleshooting/debug-microflows/18580020.png" alt="" >}}
    You can open an overview of all the breakpoints by going to **View** > **Breakpoints**:
    {{< figure src="/attachments/howto7/monitoring-troubleshooting/debug-microflows/18580019.png" alt="" >}}
...
3. Click the icon on the panes task bar to open the Modeler. The element with the breakpoint that interrupts this microflow should be highlighted with a red border:
    {{< figure src="/attachments/howto7/monitoring-troubleshooting/debug-microflows/18580010.png" alt="" >}}
4. Open the **Debugger** pane from the **View** menu:
    {{< figure src="/attachments/howto7/monitoring-troubleshooting/debug-microflows/18580009.png" alt="" >}}
...
{{< figure src="/attachments/howto7/monitoring-troubleshooting/debug-microflows/18580006.png" alt="" >}}
...
1. Right-click the activity or split in the microflow with a breakpoint and select **Edit breakpoint condition**:
    {{< figure src="/attachments/howto7/monitoring-troubleshooting/debug-microflows/18580018.png" alt="" >}}
2.  Use the expression below to make sure this breakpoint only interrupts the microflow if you are executing it yourself (replace `YourUserName` with your own user name):
    ...
    {{< figure src="/attachments/howto7/monitoring-troubleshooting/debug-microflows/18580012.png" alt="" >}}
