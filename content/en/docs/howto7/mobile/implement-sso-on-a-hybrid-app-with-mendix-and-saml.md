...
{{< figure src="/attachments/howto7/mobile/implement-sso-on-a-hybrid-app-with-mendix-and-saml/saml-2.0-from-wikipedia.png" alt="" >}}
...
2.  Click **Publish for Mobile App Stores**:
    ...
    {{< figure src="/attachments/howto7/mobile/implement-sso-on-a-hybrid-app-with-mendix-and-saml/download-hybrid-app-package-step1.png" alt="" >}}
    
3.  Select **Do it yourself** and then click **Download Customizable Package**:

    {{< figure src="/attachments/howto7/mobile/implement-sso-on-a-hybrid-app-with-mendix-and-saml/download-hybrid-app-package-step2.png" alt="" >}}
...
5.  Edit the *Entry.js* file (under `src\www\scripts`). The file should look like this:
    ...
    {{< figure src="/attachments/howto7/mobile/implement-sso-on-a-hybrid-app-with-mendix-and-saml/entry.js.png" alt="" >}}
...
6.  Add the JavaScript code provided in [5.1 The JavaScript](#javascript) under `MxApp.onConfigReady(function(config) {`. Your *Entry.js* file should now look like this:
    ​     
    {{< figure src="/attachments/howto7/mobile/implement-sso-on-a-hybrid-app-with-mendix-and-saml/entry.js-with-fix.png" alt="" >}}
...
8.  Create an APK or iOS package from the PhoneGap Build package. You can upload the new PhoneGap Build package (in the **dist** folder) to PhoneGap to build the APK or iOS binary.
    ...
    {{< figure src="/attachments/howto7/mobile/implement-sso-on-a-hybrid-app-with-mendix-and-saml/build.phonegap.com.png" alt="" >}}
...
{{< figure src="/attachments/howto7/mobile/implement-sso-on-a-hybrid-app-with-mendix-and-saml/saml-module.png" alt="" >}}
