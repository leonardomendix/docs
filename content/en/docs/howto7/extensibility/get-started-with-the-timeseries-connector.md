...
{{< figure src="/attachments/howto7/extensibility/get-started-with-the-timeseries-connector/Systemoverview.PNG" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/get-started-with-the-timeseries-connector/Domainmodel.png" alt="" >}}
...
1. Provide an **Asset name**, otherwise the connector will return an error. You are free to choose the name.
  ...
  {{< figure src="/attachments/howto7/extensibility/get-started-with-the-timeseries-connector/CreateAsset.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/get-started-with-the-timeseries-connector/create-asset-microflow.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/get-started-with-the-timeseries-connector/CreateChannel.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/get-started-with-the-timeseries-connector/create-channel-microflow.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/get-started-with-the-timeseries-connector/StoreMeasurement.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/get-started-with-the-timeseries-connector/store-measurement-microflow.png" alt="" >}}
...
1. Create an **AggregateSearchResult** object to use as the **Type parameter**. If you create a new entity, make sure it has all the necessary attributes as defined in this example:
  ...
  {{< figure src="/attachments/howto7/extensibility/get-started-with-the-timeseries-connector/example-aggregate-domain.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/get-started-with-the-timeseries-connector/AggregateSearch.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/get-started-with-the-timeseries-connector/get-aggregations-microflow.png" alt="" >}}
