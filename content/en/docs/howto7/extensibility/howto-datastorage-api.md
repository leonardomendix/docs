...
* A return type which specifies that the action returns a list of the entities specified in the previous parameter.
    ...
    {{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image003.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image005.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image007.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image009.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image011.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image013.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image017.png" alt="" >}}

Using OQL, you can query this data as follows:

{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image018.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image020.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image021.png" alt="" >}}

The result is a generic OQL action that you can use in your microflows as follows:

{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image023.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image040.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image041.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image042.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image043.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image025.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image026.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image027.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image028.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image029.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image031.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image032.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image033.png" alt="" >}}
...
1.	Specify the required SQL statement in the Java method. JDBC queries expect the parameters to be specified by question marks (?) in the SQL statement.
    ...
    {{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image034.png" alt="" >}}
...
2.	Next, use the Mendix API to execute some statements using the JDBC connection. Here you create a prepared statement, define the JDBC parameter values, and execute the SQL query.
    ...
    {{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image035.png" alt="" >}}
...
4.	Finally, return the created list of dates.
    ...
    {{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image036.png" alt="" >}}
...
{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image037.png" alt="" >}}

You will see the list of dates in the console.

{{< figure src="/attachments/howto7/extensibility/howto-datastorage-api/image039.png" alt="" >}}
