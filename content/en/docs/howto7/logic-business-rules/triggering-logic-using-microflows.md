...
5.  Select **Add button** > **Action**:
    ...
    {{< figure src="/attachments/howto7/logic-business-rules/triggering-logic-using-microflows/18580943.png" alt="" >}}
...
1.  Double-click the **Microflow** button to open its properties.
    ...
    {{< figure src="/attachments/howto7/logic-business-rules/triggering-logic-using-microflows/18580941.png" alt="" >}}
...
3. For the purposes of this how-to, you will create a new microflow. Click **New** to create this microflow, and keep the name as **Microflow**.
    ...
    {{< figure src="/attachments/howto7/logic-business-rules/triggering-logic-using-microflows/add.png" alt="" >}}
...
2.  Select **Edit microflow settings**.
    ...
    {{< figure src="/attachments/howto7/logic-business-rules/triggering-logic-using-microflows/18580938.png" alt="" >}}

    The **Microflow Settings** window opens with five sections.
    
    {{< figure src="/attachments/howto7/logic-business-rules/triggering-logic-using-microflows/18580937.png" alt="" >}}
