...
{{< figure src="/attachments/howto7/front-end/custom-error-page/monsters.png" alt="" >}}
...
2.  Go to **theme**.
    ...
    {{< figure src="/attachments/howto7/front-end/custom-error-page/theme.png" alt="" >}}

3.  Create a new folder named *error_page*.

    {{< figure src="/attachments/howto7/front-end/custom-error-page/error-page.png" alt="" >}}

4.  In the **error_page** folder, place your *offline.html* file. 

    {{< figure src="/attachments/howto7/front-end/custom-error-page/offline.png" alt="" >}}
