...
{{< figure src="/attachments/howto7/integration/implement-cicd-pipeline/01APIRightsCloudPortal.png" alt="" >}}
...
{{< figure src="/attachments/howto7/integration/implement-cicd-pipeline/02GetLatestRevision.png" alt="" >}}
...
{{< figure src="/attachments/howto7/integration/implement-cicd-pipeline/03StartBuildingPackage.png" alt="" >}}
...
{{< figure src="/attachments/howto7/integration/implement-cicd-pipeline/04RetrievePackageStatus.png" alt="" >}}
...
{{< figure src="/attachments/howto7/integration/implement-cicd-pipeline/05GetEnvironment.png" alt="" >}}
...
{{< figure src="/attachments/howto7/integration/implement-cicd-pipeline/06TransportDeploymentPackageToEnvironment.png" alt="" >}}
...
{{< figure src="/attachments/howto7/integration/implement-cicd-pipeline/07StartEnvironment.png" alt="" >}}
...
{{< figure src="/attachments/howto7/integration/implement-cicd-pipeline/08StartEnvironmentStatusStarting.png" alt="" >}}
...
{{< figure src="/attachments/howto7/integration/implement-cicd-pipeline/10StartUnitTests.png" alt="" >}}
...
{{< figure src="/attachments/howto7/integration/implement-cicd-pipeline/11UnitTestsStatus.png" alt="" >}}
...
{{< figure src="/attachments/howto7/integration/implement-cicd-pipeline/12Jenkins.png" alt="" >}}
...
{{< figure src="/attachments/howto7/integration/implement-cicd-pipeline/13RestExampleVSTS_cut.png" alt="" >}}
