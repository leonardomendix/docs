...
{{< figure src="/attachments/howto7/general/minimize-number/object_flow.png" >}}
...
{{< figure src="/attachments/howto7/general/minimize-number/domain_model_npe.png" >}}

Then link the object to the current session when you create it in a microflow:

{{< figure src="/attachments/howto7/general/minimize-number/create_object_dialog.png" >}}
