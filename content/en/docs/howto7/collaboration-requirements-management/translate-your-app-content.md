...
1.  In the **Project Explorer**, open the app **Settings** and go to the **Languages** tab.
    ...
    {{< figure src="/attachments/howto7/collaboration-requirements-management/translate-your-app-content/01_project_settings.png" alt="" >}}

2.  Click **Add**, select the desired language, and click **OK**.

    {{< figure src="/attachments/howto7/collaboration-requirements-management/translate-your-app-content/02_dutch.png" alt="" >}}
...
{{< figure src="/attachments/howto7/collaboration-requirements-management/translate-your-app-content/04_switch_development_language.png" alt="" >}}
...
{{< figure src="/attachments/howto7/collaboration-requirements-management/translate-your-app-content/language_operations.png" alt="" >}}
...
3.  The results will appear in the table with the column headers **Text** and **Replace with** (as in the example image below, in which "Schedule" is being searched).
    ...
    {{< figure src="/attachments/howto7/collaboration-requirements-management/translate-your-app-content/08_batch_replace_2.png" alt="" >}}
...
4.  The results will appear in the table with the column headers **Source** and **Translation** (as in the example image below, in which "Password" is being searched).
    ...
    {{< figure src="/attachments/howto7/collaboration-requirements-management/translate-your-app-content/11_filter_module.png" alt="" >}}
