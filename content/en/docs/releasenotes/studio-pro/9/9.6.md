...
* We fixed an issue where switching between tab pages with the [Refresh on show](/refguide/tab-container/#refresh) property set to **Yes** no longer displayed its contents correctly. (Ticket 139078)
...
#### Updated Studio Pro Look & Feel {#studio-pro-new-design}
