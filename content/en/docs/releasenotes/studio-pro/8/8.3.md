...
Finally, when it comes to collaborating with users in , the [History of](/refguide8/history-dialog/) dialog box now shows which documents were changed in Studio.
