...
1.  Open the downloaded Mendix Studio Pro executable. It is named like this: *Mendix-9.X.X-Setup*. Then click **Next**:
	...
	{{% image_container width="400" %}}{{< figure src="/attachments/howto/general/install/setup-wizard.png" >}}
	{{% /image_container %}}

2.  Select **I accept the terms in the License Agreement** and click **Next**:

	{{% image_container width="400" %}}{{< figure src="/attachments/howto/general/install/terms-of-use.png" >}}
	{{% /image_container %}}

3.  Select the folder in which you want to install Studio Pro and click **Next**:

	{{% image_container width="400" %}}{{< figure src="/attachments/howto/general/install/select-folder.png" >}}
	{{% /image_container %}}

4.  Enter the start menu shortcuts folder you want to use and click **Next**:

	{{% image_container width="400" %}}{{< figure src="/attachments/howto/general/install/shortcut-folder.png" >}}
	{{% /image_container %}}
...
6.  Click **Install** to install Studio Pro on your computer:
	...
	{{% image_container width="400" %}}{{< figure src="/attachments/howto/general/install/ready-to-install.png" >}}
	{{% /image_container %}}
