...
{{< figure src="/attachments/howto/front-end/layouts-and-snippets/layout-compare.png" alt="" >}}
...
{{< figure src="/attachments/howto/front-end/layouts-and-snippets/placeholders.png" alt="" >}} 
...
*  Basic layout for responsive/desktop pages:
	...
	{{< figure src="/attachments/howto/front-end/layouts-and-snippets/basic-desktop.png" alt="" >}}

* Basic layout for mobile pages:

	{{< figure src="/attachments/howto/front-end/layouts-and-snippets/basic-mobile.png" alt="" >}}

* Master layout with added menu:

	{{< figure src="/attachments/howto/front-end/layouts-and-snippets/master.png" alt="" >}}
...
{{< figure src="/attachments/howto/front-end/layouts-and-snippets/menu-bar.png" alt="" >}}
...
{{< figure src="/attachments/howto/front-end/layouts-and-snippets/nav-tree.png" alt="" >}}
...
{{< figure src="/attachments/howto/front-end/layouts-and-snippets/simple-menu.png" alt="" >}}
...
{{< figure src="/attachments/howto/front-end/layouts-and-snippets/edit-menu-bar.png" alt="" >}}
...
{{< figure src="/attachments/howto/front-end/layouts-and-snippets/device-profiles.png" alt="" >}}
...
{{< figure src="/attachments/howto/front-end/layouts-and-snippets/menu-document.png" alt="" >}}
...
{{< figure src="/attachments/howto/front-end/layouts-and-snippets/snippet.png" alt="" >}}
