...
1.  Open the properties of your Google Maps widget and go to the **Customisation** tab.
    {{< figure src="/attachments/howto/front-end/style-google-maps/19398957.png" alt="" >}}

2.  Simply enter the style in the **Style Array** section and you're done!
    {{< figure src="/attachments/howto/front-end/style-google-maps/19398956.png" alt="" >}}
...
3.  The example style will give you this result:
    {{< figure src="/attachments/howto/front-end/style-google-maps/19398958.png" alt="" >}}
...
1.  On the website click **Explore:**
    {{< figure src="/attachments/howto/front-end/style-google-maps/19398959.png" alt="" >}}
2.  Explore the styles to find one that matches your application and click it:
    {{< figure src="/attachments/howto/front-end/style-google-maps/19398960.png" alt="" >}}
3.  On the lefthand pane you will see the style array:
    {{< figure src="/attachments/howto/front-end/style-google-maps/19398961.png" alt="" >}}
...
5.  Open the **Customisation** tab of the Google Maps widget and paste the style array you just copied from snazzymaps:
    ...
    {{< figure src="/attachments/howto/front-end/style-google-maps/19398962.png" alt="" >}}
...
6.  And there it is:
    {{< figure src="/attachments/howto/front-end/style-google-maps/19398963.png" alt="" >}}
...
1.  Go-to Snazzymaps and click **Create.**
    **{{< figure src="/attachments/howto/front-end/style-google-maps/19398964.png" alt="" >}}** 
2.  Now you will see the same sort of handy quick style method that Mendix provides at the [Atlas 3](https://atlas.mendix.com/) site.
    {{< figure src="/attachments/howto/front-end/style-google-maps/19398965.png" alt="" >}} 
