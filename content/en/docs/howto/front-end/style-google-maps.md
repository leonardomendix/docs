...
1.  Open the properties of your Google Maps widget and go to the **Customisation** tab.
    ![](/attachments/howto/front-end/style-google-maps/19398957.png)

2.  Simply enter the style in the **Style Array** section and you're done!
    ![](/attachments/howto/front-end/style-google-maps/19398956.png)
...
3.  The example style will give you this result:
    ![](/attachments/howto/front-end/style-google-maps/19398958.png)
...
1.  On the website click **Explore:**
    ![](/attachments/howto/front-end/style-google-maps/19398959.png)
2.  Explore the styles to find one that matches your application and click it:
    ![](/attachments/howto/front-end/style-google-maps/19398960.png)
3.  On the lefthand pane you will see the style array:
    ![](/attachments/howto/front-end/style-google-maps/19398961.png)
...
5.  Open the **Customisation** tab of the Google Maps widget and paste the style array you just copied from snazzymaps:
    ...
    ![](/attachments/howto/front-end/style-google-maps/19398962.png)
...
6.  And there it is:
    ![](/attachments/howto/front-end/style-google-maps/19398963.png)
