...
2. Drag the **Execute statement** action to your microflow: 
	...
	{{< figure src="/attachments/howto/integration/execute-an-sql-statement-on-an-external-database/19399123.png" alt="" >}}
...
3. Configure the statement:
	...
	* Specify the **Output Variable name**
	...
	{{< figure src="/attachments/howto/integration/execute-an-sql-statement-on-an-external-database/19399146.png" alt="" >}}
