...
![Mendix Runtime Architecture](/attachments/howto/security/best-practices-security/mendix-runtime-architecture.png)
{{% /image_container %}}
...
![Mendix Cloud Access Restrictions Overview](/attachments/howto/security/best-practices-security/default-access-restrictions.png)
