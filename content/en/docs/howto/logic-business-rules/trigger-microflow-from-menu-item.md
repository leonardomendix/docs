...
2. In the **Responsive** tab > the **Menu** section, click **New Item**:
    ...
    {{< figure src="/attachments/howto/logic-business-rules/trigger-microflow-from-menu-item/new-menu-item.jpg" alt="" >}}

3. In the **New Menu Item** dialog box, set the **Caption** to *Hello World*:

    {{< figure src="/attachments/howto/logic-business-rules/trigger-microflow-from-menu-item/caption.png" alt="" >}}

4. For **On click**, select **Call a microflow**:

    {{< figure src="/attachments/howto/logic-business-rules/trigger-microflow-from-menu-item/call-microflow.png" alt="" >}}

5. In the **Select Microflow** dialog box, select a microflow and then click **New**:

    {{< figure src="/attachments/howto/logic-business-rules/trigger-microflow-from-menu-item/new-microflow.png" alt="" >}}
...
1.  Open the **Hello World** microflow by right-clicking the new menu item created in the [Creating a Menu Item](#creating-menu-item) section above and selecting **Go to target** from the context menu:
    ...
    {{< figure src="/attachments/howto/logic-business-rules/trigger-microflow-from-menu-item/go-to-target.png" alt="" >}}

    You will see an empty microflow like this:

    {{< figure src="/attachments/howto/logic-business-rules/trigger-microflow-from-menu-item/created-microflow.png" alt="" >}}

2.  Open the **Toolbox** and search for the **Show message** activity:
    
    {{< figure src="/attachments/howto/logic-business-rules/trigger-microflow-from-menu-item/toolbox.png" alt="" >}}
...
3.  Drag the **Show message** activity from the **Toolbox** to the flow between the start event and end event, which will insert a show message activity:
    ...
    {{< figure src="/attachments/howto/logic-business-rules/trigger-microflow-from-menu-item/show-message-activity.png" alt="" >}}
...
5.  Enter *Hello World* for the **Template** value and click **OK**:
    ...
    {{< figure src="/attachments/howto/logic-business-rules/trigger-microflow-from-menu-item/show-message-properties.png" alt="" >}}
...
7. Click the **Hello World** menu item in the menu bar to see the message:
    ...
    {{< figure src="/attachments/howto/logic-business-rules/trigger-microflow-from-menu-item/hello-world-message.png" alt="" >}}
