...
Your code alterations will produce the following result:
	...
	{{% image_container width="500" %}}![property dialog Studio Pro](/attachments/howto/extensibility/pluggable-widgets/create-a-pluggable-widget-two/property-grouping-studio-pro.png){{% /image_container %}}
