...
* A return type which specifies that the action returns a list of the entities specified in the previous parameter.
    ...
    {{< figure src="/attachments/howto/extensibility/howto-datastorage-api/image003.png" >}}
...
{{< figure src="/attachments/howto/extensibility/howto-datastorage-api/image005.png" >}}
...
{{< figure src="/attachments/howto/extensibility/howto-datastorage-api/image017.png" >}}

Using OQL, you can query this data as follows:

{{< figure src="/attachments/howto/extensibility/howto-datastorage-api/image018.png" >}}
...
{{< figure src="/attachments/howto/extensibility/howto-datastorage-api/image020.png" >}}
...
{{< figure src="/attachments/howto/extensibility/howto-datastorage-api/image021.png" >}}

The result is a generic OQL action that you can use in your microflows as follows:

{{< figure src="/attachments/howto/extensibility/howto-datastorage-api/image023.png" >}}
...
{{< figure src="/attachments/howto/extensibility/howto-datastorage-api/image040.png" >}}
...
{{< figure src="/attachments/howto/extensibility/howto-datastorage-api/image041.png" >}}
...
{{< figure src="/attachments/howto/extensibility/howto-datastorage-api/image025.png" >}}
...
{{< figure src="/attachments/howto/extensibility/howto-datastorage-api/image029.png" >}}
...
{{< figure src="/attachments/howto/extensibility/howto-datastorage-api/image031.png" >}}
...
{{< figure src="/attachments/howto/extensibility/howto-datastorage-api/image032.png" >}}
...
{{< figure src="/attachments/howto/extensibility/howto-datastorage-api/image033.png" >}}
...
{{< figure src="/attachments/howto/extensibility/howto-datastorage-api/image037.png" >}}

You will see the list of dates in the console.

{{< figure src="/attachments/howto/extensibility/howto-datastorage-api/image039.png" >}}
