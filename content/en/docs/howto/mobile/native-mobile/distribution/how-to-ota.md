...
1.  Select **Enable over-the-air updates**: 
  ...
  {{% image_container width="350" %}}{{< figure src="/attachments/howto/mobile/native-mobile/distribution/how-to-ota/ota-profile-screen.png" alt="Startup option ota checkbox" >}}{{% /image_container %}}
