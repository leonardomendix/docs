...
{{% image_container width="200" %}}{{< figure src="/attachments/howto/mobile/native-mobile/distribution/build-native-apps/native-build-locally-manually/mendix-version.png" alt="iOS output" >}}{{% /image_container %}}
...
1.  Select the source code binary to download a copy of the code:
	...
	{{% image_container width="250" %}}{{< figure src="/attachments/howto/mobile/native-mobile/distribution/build-native-apps/native-build-locally-manually/github-assets.png" alt="iOS output" >}}{{% /image_container %}}
...
1.  The **android** folder structure should be the following:
	...
	{{% image_container width="250" %}}{{< figure src="/attachments/howto/mobile/native-mobile/distribution/build-native-apps/native-build-locally-manually/android-output.png" alt="iOS output" >}}{{% /image_container %}}
