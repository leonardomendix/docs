...
*  **Unable to load script**:
	...
	{{% image_container width="250" %}}{{< figure src="/attachments/howto/mobile/native-mobile/get-started/common-issues/unabletoloadscript.png" alt="unable to load script" >}}{{% /image_container %}}

*  **Cannot detect your runtime**:

	{{% image_container width="250" %}}{{< figure src="/attachments/howto/mobile/native-mobile/get-started/common-issues/min-error-firewall.png" alt="cannot detect runtime" >}}{{% /image_container %}}
...
1. Make sure that incoming connections are allowed by doing the following:<br />
    ...
    {{% image_container width="350" %}}{{< figure src="/attachments/howto/mobile/native-mobile/get-started/common-issues/inboundrules.png" alt="inbound rules" >}}{{% /image_container %}}
