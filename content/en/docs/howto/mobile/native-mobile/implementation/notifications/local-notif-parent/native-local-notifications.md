...
{{% alert type="info" %}}
To use push notifications with apps created with the Native Mobile Builder, make sure you have completed [How To Deploy Your First Mendix Native Mobile App](/howto/mobile/deploying-native-app/) and [How to Set up Native Push Notifications](/howto/mobile/setting-up-native-push-notifications/)
{{% /alert %}}
...
3.  Drag and drop a decision after your **Has notification permission** activity onto your nanoflow:
	...
	{{% image_container width="500" %}}![app settings](/attachments/howto/mobile/native-mobile/implementation/notifications/local-notif-parent/native-local-notifications/new-decision.png){{% /image_container %}}
