...
1.  Locate the **Online_Snippet** or **Offline_Snippet** document and open it.
	...
	![](/attachments/howto/mobile/native-mobile/implementation/notifications/sending-push-notifications/push_notifications_snippets.png)

2. Double-click the widget to open the properties.

	![](/attachments/howto/mobile/native-mobile/implementation/notifications/sending-push-notifications/push_notifications_widget_settings.png)
...
![](/attachments/howto/mobile/native-mobile/implementation/notifications/sending-push-notifications/push_notifications_action.png)
