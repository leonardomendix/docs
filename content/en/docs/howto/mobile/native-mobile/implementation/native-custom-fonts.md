...
1.  Start the Mendix Native Mobile Builder:
	...
	{{% image_container width="350" %}}![Start Native Builer](/attachments/howto/mobile/native-mobile/distribution/build-native-apps/deploying-native-app/start-nbui.png){{% /image_container %}}
