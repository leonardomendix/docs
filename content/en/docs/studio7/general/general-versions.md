...
{{% image_container width="500" %}}{{< figure src="/attachments/studio7/general/general-versions/about-dialog.png" alt="" >}}
{{% /image_container %}}
...
{{< figure src="/attachments/studio7/general/general-versions/top-bar-upgrade.png" alt="" >}}
