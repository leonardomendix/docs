...
{{% image_container width="300" %}}{{< figure src="/attachments/studio7/page-editor/pages-icon.png" alt="" >}}
{{% /image_container %}}
...
2.  In the displayed list of app pages, select the one you want to open and click it.
    ...
    {{% image_container width="400" %}}{{< figure src="/attachments/studio7/page-editor/opening-a-page.png" alt="" >}}
    {{% /image_container %}}
...
2.  Click **New** in the top right corner of the displayed side panel.
    ...
    {{% image_container width="400" %}}{{< figure src="/attachments/studio7/page-editor/new-page.png" alt="" >}}
    {{% /image_container %}}

3. In the **Create new page** dialog window, fill out the title of the page, select the layout and the page template.  
4.  Click **Create**.

    {{< figure src="/attachments/studio7/page-editor/create-new-page-dialog.png" alt="" >}}
...
3.  Click **Delete** at the bottom of the **Properties** tab.
    ...
    {{< figure src="/attachments/studio7/page-editor/page-delete.png" alt="" >}}
...
{{% image_container width="400" %}}{{< figure src="/attachments/studio7/page-editor/input-widget-example.png" alt="" >}}
{{% /image_container %}}
...
{{< figure src="/attachments/studio7/page-editor/breadcrumb.png" alt="" >}}
...
{{% image_container width="300" %}}{{< figure src="/attachments/studio7/page-editor/navigation-layout.png" alt="" >}}
{{% /image_container %}}
...
{{< figure src="/attachments/studio7/page-editor/building-blocks.png" alt="" >}}
...
{{< figure src="/attachments/studio7/page-editor/info-icon-building-blocks.png" alt="" >}}
...
{{% image_container width="300" %}}{{< figure src="/attachments/studio7/page-editor/properties.png" alt="" >}}
{{% /image_container %}}
