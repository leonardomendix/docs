...
{{< figure src="/attachments/studio7/microflows/microflows-expressions/expression-tab.png" alt="" >}}
...
{{% image_container width="350" %}}{{< figure src="/attachments/studio7/microflows/microflows-expressions/expression-error.png" alt="" >}}
{{% /image_container %}}
...
{{< figure src="/attachments/studio7/microflows/microflows-expressions/expressions-list.png" alt="" >}}
...
{{< figure src="/attachments/studio7/microflows/microflows-expressions/example-decision.png" alt="" >}} 

The expression will look the following way:

{{< figure src="/attachments/studio7/microflows/microflows-expressions/expression-decision.png" alt="" >}}
...
{{< figure src="/attachments/studio7/microflows/microflows-expressions/customer-empty-and-name-example.png" alt="" >}}
