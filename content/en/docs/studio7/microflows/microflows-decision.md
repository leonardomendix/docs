...
*  [With an **Expression**](#expression-tab) (for example, you can create a comparison with it)
   ...
   {{< figure src="/attachments/studio7/microflows/microflows-decision/configure-condition-dialog.png" alt="" >}}
...
{{< figure src="/attachments/studio7/microflows/microflows-decision/decision-boolean.png" alt="" >}}
...
{{< figure src="/attachments/studio7/microflows/microflows-decision/decision-enumeration.png" alt="" >}}
