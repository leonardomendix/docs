...
{{% image_container width="350" %}}{{< figure src="/attachments/studio7/microflows/mx-assist/mx-assist-recommendations.png" >}}
{{% /image_container %}}
...
{{% image_container width="300" %}}{{< figure src="/attachments/studio7/microflows/mx-assist/info-icon-setting.png" >}}
{{% /image_container %}}
...
3.  Click the selected activity to add it to the flow.
    ...
    {{% image_container width="350" %}}{{< figure src="/attachments/studio7/microflows/mx-assist/mx-assist-list.png" >}}
    {{% /image_container %}}
...
{{% image_container width="300" %}}{{< figure src="/attachments/studio7/microflows/mx-assist/check-added.png" >}}
{{% /image_container %}}
...
2.  Find **Add a check** in the suggestions.
    ...
    {{% image_container width="350" %}}{{< figure src="/attachments/studio7/microflows/mx-assist/adding-check.png" >}}
    {{% /image_container %}}
...
2. Find **Add a decision** in the suggestions and select it.
    ...
    {{% image_container width="350" %}}{{< figure src="/attachments/studio7/microflows/mx-assist/adding-decision.png" >}}
    {{% /image_container %}}
